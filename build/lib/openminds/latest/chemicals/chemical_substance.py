...
class ChemicalSubstance(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:molecularEntity",required=True,
            description="no description available",
    ...
    def __init__(self, id=None, additional_remarks=None, lookup_label=None, molecular_entity=None, product_source=None, purity=None):
        return super().__init__(id=id,additional_remarks=additional_remarks,lookup_label=lookup_label,molecular_entity=molecular_entity,product_source=product_source,purity=purity,)
