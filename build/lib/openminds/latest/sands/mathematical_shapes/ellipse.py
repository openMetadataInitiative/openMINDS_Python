...
class Ellipse(EmbeddedMetadata):
    ...
    properties = [
        Property(
            ...
            "vocab:semiMajorAxis",required=True,
        ...
        Property(
            "semi_minor_axis",
            "openminds.latest.core.QuantitativeValue",
            "vocab:semiMinorAxis",required=True,
            description="no description available",
    ...
    def __init__(self, semi_major_axis=None, semi_minor_axis=None):
        return super().__init__(semi_major_axis=semi_major_axis,semi_minor_axis=semi_minor_axis,)
