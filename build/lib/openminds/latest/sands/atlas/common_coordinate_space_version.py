...
class CommonCoordinateSpaceVersion(LinkedMetadata):
    ...
    def __init__(self, id=None, abbreviation=None, accessibility=None, anatomical_axes_orientation=None, author=None, axes_origin=None, copyright=None, custodian=None, default_image=None, description=None, digital_identifier=None, full_documentation=None, full_name=None, funding=None, homepage=None, how_to_cite=None, is_alternative_version_of=None, is_new_version_of=None, keyword=None, license=None, native_unit=None, ontology_identifier=None, other_contribution=None, related_publication=None, release_date=None, repository=None, short_name=None, support_channel=None, used_specimen=None, version_identifier=None, version_innovation=None):
        return super().__init__(id=id,abbreviation=abbreviation,accessibility=accessibility,anatomical_axes_orientation=anatomical_axes_orientation,author=author,axes_origin=axes_origin,copyright=copyright,custodian=custodian,default_image=default_image,description=description,digital_identifier=digital_identifier,full_documentation=full_documentation,full_name=full_name,funding=funding,homepage=homepage,how_to_cite=how_to_cite,is_alternative_version_of=is_alternative_version_of,is_new_version_of=is_new_version_of,keyword=keyword,license=license,native_unit=native_unit,ontology_identifier=ontology_identifier,other_contribution=other_contribution,related_publication=related_publication,release_date=release_date,repository=repository,short_name=short_name,support_channel=support_channel,used_specimen=used_specimen,version_identifier=version_identifier,version_innovation=version_innovation,)
