...
class BrainAtlas(LinkedMetadata):
    ...
    def __init__(self, id=None, abbreviation=None, author=None, custodian=None, description=None, digital_identifier=None, full_name=None, has_terminology=None, has_version=None, homepage=None, how_to_cite=None, ontology_identifier=None, short_name=None, used_species=None):
        return super().__init__(id=id,abbreviation=abbreviation,author=author,custodian=custodian,description=description,digital_identifier=digital_identifier,full_name=full_name,has_terminology=has_terminology,has_version=has_version,homepage=homepage,how_to_cite=how_to_cite,ontology_identifier=ontology_identifier,short_name=short_name,used_species=used_species,)
