...
class ParcellationEntity(LinkedMetadata):
    ...
    def __init__(self, id=None, abbreviation=None, alternate_name=None, definition=None, has_parent=None, has_version=None, lookup_label=None, name=None, ontology_identifier=None, related_uberon_term=None):
        return super().__init__(id=id,abbreviation=abbreviation,alternate_name=alternate_name,definition=definition,has_parent=has_parent,has_version=has_version,lookup_label=lookup_label,name=name,ontology_identifier=ontology_identifier,related_uberon_term=related_uberon_term,)
