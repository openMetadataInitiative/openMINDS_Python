...
class QuantitativeRelationAssessment(EmbeddedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:quantitativeOverlap",required=True,
    ...
    def __init__(self, criteria=None, in_relation_to=None, quantitative_overlap=None):
        return super().__init__(criteria=criteria,in_relation_to=in_relation_to,quantitative_overlap=quantitative_overlap,)
