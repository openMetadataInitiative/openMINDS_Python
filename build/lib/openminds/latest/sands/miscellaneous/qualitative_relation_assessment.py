...
class QualitativeRelationAssessment(EmbeddedMetadata):
    ...
    properties = [
        ...
        Property(
            "in_relation_to",
            ['openminds.latest.sands.CustomAnatomicalEntity', 'openminds.latest.sands.ParcellationEntity', 'openminds.latest.sands.ParcellationEntityVersion'],
    ...
    def __init__(self, criteria=None, in_relation_to=None, qualitative_overlap=None):
        return super().__init__(criteria=criteria,in_relation_to=in_relation_to,qualitative_overlap=qualitative_overlap,)
