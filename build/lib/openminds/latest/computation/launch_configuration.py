...
class LaunchConfiguration(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "executable",
            str,
            "vocab:executable",formatting="text/plain",
    ...
    def __init__(self, id=None, argument=None, description=None, environment_variable=None, executable=None, name=None):
        return super().__init__(id=id,argument=argument,description=description,environment_variable=environment_variable,executable=executable,name=name,)
