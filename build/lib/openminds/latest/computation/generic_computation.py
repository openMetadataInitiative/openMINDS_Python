...
class GenericComputation(LinkedMetadata):
    """
    Structured information about a computation whose type is unknown or unspecified.
    """
    ...
    properties = [
        ...
        Property(
            "input",
            ['openminds.latest.computation.LocalFile', 'openminds.latest.core.File', 'openminds.latest.core.FileBundle', 'openminds.latest.core.SoftwareVersion'],
            "vocab:input",
            multiple=True,
            unique_items=True,
            min_items=1,
