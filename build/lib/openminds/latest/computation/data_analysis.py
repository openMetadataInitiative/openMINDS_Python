...
class DataAnalysis(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:environment",required=True,
            description="no description available",
            instructions="Add the computational environment in which this computation was executed."
        ),
        Property(
            "input",
            ['openminds.latest.computation.LocalFile', 'openminds.latest.core.File', 'openminds.latest.core.FileBundle', 'openminds.latest.core.SoftwareVersion', 'openminds.latest.sands.BrainAtlasVersion', 'openminds.latest.sands.CommonCoordinateSpaceVersion'],
            "vocab:input",
            multiple=True,
            unique_items=True,
            min_items=1,
        ...
        Property(
            "output",
            ['openminds.latest.computation.LocalFile', 'openminds.latest.core.File', 'openminds.latest.core.FileArchive', 'openminds.latest.core.FileBundle'],
            "vocab:output",
            multiple=True,
            unique_items=True,
            min_items=1,
    ...
    def __init__(self, id=None, custom_property_set=None, description=None, end_time=None, environment=None, input=None, launch_configuration=None, lookup_label=None, output=None, performed_by=None, recipe=None, resource_usage=None, start_time=None, started_by=None, status=None, study_target=None, tag=None, technique=None, was_informed_by=None):
        return super().__init__(id=id,custom_property_set=custom_property_set,description=description,end_time=end_time,environment=environment,input=input,launch_configuration=launch_configuration,lookup_label=lookup_label,output=output,performed_by=performed_by,recipe=recipe,resource_usage=resource_usage,start_time=start_time,started_by=started_by,status=status,study_target=study_target,tag=tag,technique=technique,was_informed_by=was_informed_by,)
