...
class WebService(LinkedMetadata):
    ...
    def __init__(self, id=None, custodian=None, description=None, developer=None, full_name=None, has_version=None, homepage=None, how_to_cite=None, short_name=None):
        return super().__init__(id=id,custodian=custodian,description=description,developer=developer,full_name=full_name,has_version=has_version,homepage=homepage,how_to_cite=how_to_cite,short_name=short_name,)
