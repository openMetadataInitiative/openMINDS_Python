...
class ServiceLink(LinkedMetadata):
    ...
    properties = [
        Property(
            "data_location",
            ['openminds.latest.core.File', 'openminds.latest.core.FileArchive', 'openminds.latest.core.FileBundle', 'openminds.latest.core.ModelVersion', 'openminds.latest.publications.LivePaperResourceItem', 'openminds.latest.sands.ParcellationEntityVersion'],
        ...
        Property(
            "display_label",
            str,
            "vocab:displayLabel",formatting="text/plain",
        ...
        Property(
            "open_data_in",
            IRI,
            "vocab:openDataIn",required=True,
            description="no description available",
    ...
    def __init__(self, id=None, data_location=None, display_label=None, open_data_in=None, preview_image=None, service=None):
        return super().__init__(id=id,data_location=data_location,display_label=display_label,open_data_in=open_data_in,preview_image=preview_image,service=service,)
