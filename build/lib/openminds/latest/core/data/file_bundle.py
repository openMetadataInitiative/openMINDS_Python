...
class FileBundle(LinkedMetadata):
    ...
    def __init__(self, id=None, content_description=None, format=None, grouped_by=None, grouping_type=None, hash=None, is_part_of=None, name=None, storage_size=None):
        return super().__init__(id=id,content_description=content_description,format=format,grouped_by=grouped_by,grouping_type=grouping_type,hash=hash,is_part_of=is_part_of,name=name,storage_size=storage_size,)
