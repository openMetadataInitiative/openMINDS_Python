...
class File(LinkedMetadata):
    ...
    def __init__(self, id=None, iri=None, content_description=None, data_type=None, file_repository=None, format=None, hash=None, is_part_of=None, name=None, special_usage_role=None, storage_size=None):
        return super().__init__(id=id,iri=iri,content_description=content_description,data_type=data_type,file_repository=file_repository,format=format,hash=hash,is_part_of=is_part_of,name=name,special_usage_role=special_usage_role,storage_size=storage_size,)
