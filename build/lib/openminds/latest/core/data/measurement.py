...
class Measurement(EmbeddedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:measuredQuantity",required=True,
    ...
    def __init__(self, additional_remarks=None, measured_quantity=None, measured_with=None, timestamp=None, value=None):
        return super().__init__(additional_remarks=additional_remarks,measured_quantity=measured_quantity,measured_with=measured_with,timestamp=timestamp,value=value,)
