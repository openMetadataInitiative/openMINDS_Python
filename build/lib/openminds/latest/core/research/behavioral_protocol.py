...
class BehavioralProtocol(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "stimulation",
            ['openminds.latest.controlled_terms.StimulationApproach', 'openminds.latest.controlled_terms.StimulationTechnique'],
            "vocab:stimulation",
            multiple=True,
            unique_items=True,
            min_items=1,
        ...
        Property(
            "stimulus_type",
            ['openminds.latest.controlled_terms.AuditoryStimulusType', 'openminds.latest.controlled_terms.ElectricalStimulusType', 'openminds.latest.controlled_terms.GustatoryStimulusType', 'openminds.latest.controlled_terms.OlfactoryStimulusType', 'openminds.latest.controlled_terms.OpticalStimulusType', 'openminds.latest.controlled_terms.TactileStimulusType', 'openminds.latest.controlled_terms.VisualStimulusType'],
            "vocab:stimulusType",
            multiple=True,
            unique_items=True,
            min_items=1,
    ...
    def __init__(self, id=None, described_in=None, description=None, internal_identifier=None, name=None, stimulation=None, stimulus_type=None):
        return super().__init__(id=id,described_in=described_in,description=description,internal_identifier=internal_identifier,name=name,stimulation=stimulation,stimulus_type=stimulus_type,)
