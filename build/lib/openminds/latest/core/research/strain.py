...
class Strain(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:geneticStrainType",required=True,
            description="no description available",
        ...
        Property(
            "laboratory_code",
            str,
            "vocab:laboratoryCode",formatting="text/plain",
        ...
        Property(
            "phenotype",
            str,
            "vocab:phenotype",formatting="text/plain",
    ...
    def __init__(self, id=None, alternate_identifier=None, background_strain=None, breeding_type=None, description=None, digital_identifier=None, disease_model=None, genetic_strain_type=None, laboratory_code=None, name=None, ontology_identifier=None, phenotype=None, species=None, stock_number=None, synonym=None):
        return super().__init__(id=id,alternate_identifier=alternate_identifier,background_strain=background_strain,breeding_type=breeding_type,description=description,digital_identifier=digital_identifier,disease_model=disease_model,genetic_strain_type=genetic_strain_type,laboratory_code=laboratory_code,name=name,ontology_identifier=ontology_identifier,phenotype=phenotype,species=species,stock_number=stock_number,synonym=synonym,)
