...
class TissueSample(LinkedMetadata):
    ...
    def __init__(self, id=None, anatomical_location=None, biological_sex=None, internal_identifier=None, is_part_of=None, laterality=None, lookup_label=None, origin=None, species=None, studied_state=None, type=None):
        return super().__init__(id=id,anatomical_location=anatomical_location,biological_sex=biological_sex,internal_identifier=internal_identifier,is_part_of=is_part_of,laterality=laterality,lookup_label=lookup_label,origin=origin,species=species,studied_state=studied_state,type=type,)
