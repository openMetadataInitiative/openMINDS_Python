...
class TissueSampleCollection(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "origin",
            ['openminds.latest.controlled_terms.CellType', 'openminds.latest.controlled_terms.Organ', 'openminds.latest.controlled_terms.OrganismSubstance'],
            "vocab:origin",
            multiple=True,
            unique_items=True,
            min_items=1,
    ...
    def __init__(self, id=None, additional_remarks=None, anatomical_location=None, biological_sex=None, internal_identifier=None, laterality=None, lookup_label=None, number_of_tissue_samples=None, origin=None, species=None, studied_state=None, type=None):
        return super().__init__(id=id,additional_remarks=additional_remarks,anatomical_location=anatomical_location,biological_sex=biological_sex,internal_identifier=internal_identifier,laterality=laterality,lookup_label=lookup_label,number_of_tissue_samples=number_of_tissue_samples,origin=origin,species=species,studied_state=studied_state,type=type,)
