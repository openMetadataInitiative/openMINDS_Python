...
class PipetteUsage(LinkedMetadata):
    ...
    properties = [
        Property(
            "anatomical_location",
            ['openminds.latest.controlled_terms.CellType', 'openminds.latest.controlled_terms.Organ', 'openminds.latest.controlled_terms.OrganismSubstance', 'openminds.latest.controlled_terms.SubcellularEntity', 'openminds.latest.controlled_terms.UBERONParcellation', 'openminds.latest.sands.CustomAnatomicalEntity', 'openminds.latest.sands.ParcellationEntity', 'openminds.latest.sands.ParcellationEntityVersion'],
        ...
        Property(
            ...
            "vocab:pipetteSolution",required=True,
            description="no description available",
    ...
    def __init__(self, id=None, anatomical_location=None, chloride_reversal_potential=None, compensation_current=None, device=None, end_membrane_potential=None, holding_potential=None, input_resistance=None, labeling_compound=None, liquid_junction_potential=None, lookup_label=None, metadata_location=None, pipette_resistance=None, pipette_solution=None, seal_resistance=None, series_resistance=None, spatial_location=None, start_membrane_potential=None, used_specimen=None):
        return super().__init__(id=id,anatomical_location=anatomical_location,chloride_reversal_potential=chloride_reversal_potential,compensation_current=compensation_current,device=device,end_membrane_potential=end_membrane_potential,holding_potential=holding_potential,input_resistance=input_resistance,labeling_compound=labeling_compound,liquid_junction_potential=liquid_junction_potential,lookup_label=lookup_label,metadata_location=metadata_location,pipette_resistance=pipette_resistance,pipette_solution=pipette_solution,seal_resistance=seal_resistance,series_resistance=series_resistance,spatial_location=spatial_location,start_membrane_potential=start_membrane_potential,used_specimen=used_specimen,)
