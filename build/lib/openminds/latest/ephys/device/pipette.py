...
class Pipette(LinkedMetadata):
    ...
    def __init__(self, id=None, description=None, device_type=None, digital_identifier=None, external_diameter=None, internal_diameter=None, internal_identifier=None, lookup_label=None, manufacturer=None, material=None, name=None, owner=None, serial_number=None):
        return super().__init__(id=id,description=description,device_type=device_type,digital_identifier=digital_identifier,external_diameter=external_diameter,internal_diameter=internal_diameter,internal_identifier=internal_identifier,lookup_label=lookup_label,manufacturer=manufacturer,material=material,name=name,owner=owner,serial_number=serial_number,)
