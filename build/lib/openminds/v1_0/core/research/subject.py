...
class Subject(LinkedMetadata):
    ...
    def __init__(self, id=None, biological_sex=None, genotype=None, internal_identifier=None, phenotype=None, species=None, strain=None, studied_state=None):
        return super().__init__(id=id,biological_sex=biological_sex,genotype=genotype,internal_identifier=internal_identifier,phenotype=phenotype,species=species,strain=strain,studied_state=studied_state,)
