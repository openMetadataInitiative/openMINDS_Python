...
class AnatomicalEntityRelation(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:inRelationTo",required=True,
        ...
        Property(
            ...
            "vocab:qualitativeOverlap",required=True,
    ...
    def __init__(self, id=None, criteria=None, criteria_quality_type=None, in_relation_to=None, qualitative_overlap=None, quantitative_overlap=None):
        return super().__init__(id=id,criteria=criteria,criteria_quality_type=criteria_quality_type,in_relation_to=in_relation_to,qualitative_overlap=qualitative_overlap,quantitative_overlap=quantitative_overlap,)
