...
class BrainAtlasVersion(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:terminology",required=True,
    ...
    def __init__(self, id=None, annotation_set=None, coordinate_space=None, digital_identifier=None, full_name=None, has_alternative_version=None, homepage=None, is_new_version_of=None, ontology_identifier=None, release_date=None, short_name=None, terminology=None, version_identifier=None, version_innovation=None):
        return super().__init__(id=id,annotation_set=annotation_set,coordinate_space=coordinate_space,digital_identifier=digital_identifier,full_name=full_name,has_alternative_version=has_alternative_version,homepage=homepage,is_new_version_of=is_new_version_of,ontology_identifier=ontology_identifier,release_date=release_date,short_name=short_name,terminology=terminology,version_identifier=version_identifier,version_innovation=version_innovation,)
