...
class Strain(LinkedMetadata):
    ...
    def __init__(self, id=None, definition=None, description=None, identifier=None, name=None, ontology_identifier=None):
        return super().__init__(id=id,definition=definition,description=description,identifier=identifier,name=name,ontology_identifier=ontology_identifier,)
