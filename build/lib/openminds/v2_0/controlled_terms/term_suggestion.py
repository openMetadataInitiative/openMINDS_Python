...
class TermSuggestion(LinkedMetadata):
    ...
    def __init__(self, id=None, add_existing_terminology=None, definition=None, description=None, name=None, ontology_identifier=None, suggest_new_terminology=None):
        return super().__init__(id=id,add_existing_terminology=add_existing_terminology,definition=definition,description=description,name=name,ontology_identifier=ontology_identifier,suggest_new_terminology=suggest_new_terminology,)
