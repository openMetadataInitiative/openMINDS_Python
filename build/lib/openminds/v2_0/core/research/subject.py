...
class Subject(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "is_part_of",
            "openminds.v2_0.core.SubjectGroup",
            "vocab:isPartOf",
            multiple=True,
            unique_items=True,
            min_items=1,
    ...
    def __init__(self, id=None, biological_sex=None, internal_identifier=None, is_part_of=None, lookup_label=None, phenotype=None, species=None, strain=None, studied_state=None):
        return super().__init__(id=id,biological_sex=biological_sex,internal_identifier=internal_identifier,is_part_of=is_part_of,lookup_label=lookup_label,phenotype=phenotype,species=species,strain=strain,studied_state=studied_state,)
