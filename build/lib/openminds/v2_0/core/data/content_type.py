...
class ContentType(LinkedMetadata):
    ...
    def __init__(self, id=None, description=None, file_extension=None, name=None, related_media_type=None, specification=None, synonym=None):
        return super().__init__(id=id,description=description,file_extension=file_extension,name=name,related_media_type=related_media_type,specification=specification,synonym=synonym,)
