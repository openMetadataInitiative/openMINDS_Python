...
class FileBundle(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "grouped_by",
            "openminds.v2_0.controlled_terms.FileBundleGrouping",
            "vocab:groupedBy",
        ...
        Property(
            "is_part_of",
            ['openminds.v2_0.core.FileBundle', 'openminds.v2_0.core.FileRepository'],
        ...
        Property(
            ...
            str,
            "vocab:patternOfFilenames",formatting="text/plain",
    ...
    def __init__(self, id=None, format=None, grouped_by=None, hash=None, is_part_of=None, name=None, pattern_of_filenames=None, storage_size=None):
        return super().__init__(id=id,format=format,grouped_by=grouped_by,hash=hash,is_part_of=is_part_of,name=name,pattern_of_filenames=pattern_of_filenames,storage_size=storage_size,)
