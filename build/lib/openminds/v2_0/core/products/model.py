...
class Model(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "study_target",
            ['openminds.v2_0.controlled_terms.BiologicalSex', 'openminds.v2_0.controlled_terms.CellType', 'openminds.v2_0.controlled_terms.Disease', 'openminds.v2_0.controlled_terms.DiseaseModel', 'openminds.v2_0.controlled_terms.Handedness', 'openminds.v2_0.controlled_terms.Organ', 'openminds.v2_0.controlled_terms.Phenotype', 'openminds.v2_0.controlled_terms.Species', 'openminds.v2_0.controlled_terms.Strain', 'openminds.v2_0.controlled_terms.TermSuggestion', 'openminds.v2_0.sands.CustomAnatomicalEntity', 'openminds.v2_0.sands.ParcellationEntity'],
            "vocab:studyTarget",
            multiple=True,
            unique_items=True,
            min_items=1,
    ...
    def __init__(self, id=None, abstraction_level=None, custodian=None, description=None, developer=None, digital_identifier=None, full_name=None, has_version=None, homepage=None, how_to_cite=None, scope=None, short_name=None, study_target=None):
        return super().__init__(id=id,abstraction_level=abstraction_level,custodian=custodian,description=description,developer=developer,digital_identifier=digital_identifier,full_name=full_name,has_version=has_version,homepage=homepage,how_to_cite=how_to_cite,scope=scope,short_name=short_name,study_target=study_target,)
