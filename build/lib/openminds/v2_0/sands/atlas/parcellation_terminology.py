...
class ParcellationTerminology(LinkedMetadata):
    ...
    def __init__(self, id=None, defined_in=None, full_name=None, is_alternative_version_of=None, is_new_version_of=None, ontology_identifier=None, short_name=None, version_identifier=None, version_innovation=None):
        return super().__init__(id=id,defined_in=defined_in,full_name=full_name,is_alternative_version_of=is_alternative_version_of,is_new_version_of=is_new_version_of,ontology_identifier=ontology_identifier,short_name=short_name,version_identifier=version_identifier,version_innovation=version_innovation,)
