...
class AtlasAnnotation(LinkedMetadata):
    ...
    def __init__(self, id=None, best_view_point=None, criteria=None, criteria_quality_type=None, display_color=None, inspired_by=None, internal_identifier=None, laterality=None, lookup_label=None, name=None, version_identifier=None, version_innovation=None, visualized_in=None):
        return super().__init__(id=id,best_view_point=best_view_point,criteria=criteria,criteria_quality_type=criteria_quality_type,display_color=display_color,inspired_by=inspired_by,internal_identifier=internal_identifier,laterality=laterality,lookup_label=lookup_label,name=name,version_identifier=version_identifier,version_innovation=version_innovation,visualized_in=visualized_in,)
