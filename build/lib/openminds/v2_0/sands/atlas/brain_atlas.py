...
class BrainAtlas(LinkedMetadata):
    ...
    def __init__(self, id=None, description=None, digital_identifier=None, full_name=None, has_version=None, homepage=None, how_to_cite=None, short_name=None):
        return super().__init__(id=id,description=description,digital_identifier=digital_identifier,full_name=full_name,has_version=has_version,homepage=homepage,how_to_cite=how_to_cite,short_name=short_name,)
