...
class ElectrodeContact(LinkedMetadata):
    ...
    def __init__(self, id=None, coordinate_point=None, defined_in=None, internal_identifier=None, lookup_label=None, related_recording=None, related_stimulation=None, visualized_in=None):
        return super().__init__(id=id,coordinate_point=coordinate_point,defined_in=defined_in,internal_identifier=internal_identifier,lookup_label=lookup_label,related_recording=related_recording,related_stimulation=related_stimulation,visualized_in=visualized_in,)
