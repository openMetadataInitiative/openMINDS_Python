...
class SubjectGroupState(LinkedMetadata):
    ...
    def __init__(self, id=None, additional_remarks=None, age=None, age_category=None, handedness=None, lookup_label=None, pathology=None, weight=None):
        return super().__init__(id=id,additional_remarks=additional_remarks,age=age,age_category=age_category,handedness=handedness,lookup_label=lookup_label,pathology=pathology,weight=weight,)
