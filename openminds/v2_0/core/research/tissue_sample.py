...
class TissueSample(LinkedMetadata):
    ...
    properties = [
        Property(
            ...
            "vocab:biologicalSex",required=True,
        ...
        Property(
            "is_part_of",
            "openminds.v2_0.core.TissueSampleCollection",
            "vocab:isPartOf",
            multiple=True,
            unique_items=True,
            min_items=1,
    ...
    def __init__(self, id=None, biological_sex=None, internal_identifier=None, is_part_of=None, laterality=None, lookup_label=None, origin=None, phenotype=None, species=None, strain=None, studied_state=None, type=None):
        return super().__init__(id=id,biological_sex=biological_sex,internal_identifier=internal_identifier,is_part_of=is_part_of,laterality=laterality,lookup_label=lookup_label,origin=origin,phenotype=phenotype,species=species,strain=strain,studied_state=studied_state,type=type,)
