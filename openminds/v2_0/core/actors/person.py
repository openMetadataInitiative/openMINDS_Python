...
class Person(LinkedMetadata):
    ...
    def __init__(self, id=None, affiliation=None, contact_information=None, digital_identifier=None, family_name=None, given_name=None):
        return super().__init__(id=id,affiliation=affiliation,contact_information=contact_information,digital_identifier=digital_identifier,family_name=family_name,given_name=given_name,)
