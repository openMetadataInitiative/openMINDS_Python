...
class FileRepository(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "repository_type",
            "openminds.v2_0.controlled_terms.FileRepositoryType",
            "vocab:repositoryType",
    ...
    def __init__(self, id=None, iri=None, format=None, hash=None, hosted_by=None, name=None, repository_type=None, storage_size=None):
        return super().__init__(id=id,iri=iri,format=format,hash=hash,hosted_by=hosted_by,name=name,repository_type=repository_type,storage_size=storage_size,)
