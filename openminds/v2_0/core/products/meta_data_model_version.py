...
class MetaDataModelVersion(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "type",
            "openminds.v2_0.controlled_terms.MetaDataModelType",
            "vocab:type",required=True,
    ...
    def __init__(self, id=None, accessibility=None, copyright=None, custodian=None, description=None, developer=None, digital_identifier=None, full_documentation=None, full_name=None, funding=None, homepage=None, how_to_cite=None, is_alternative_version_of=None, is_new_version_of=None, keyword=None, license=None, other_contribution=None, related_publication=None, release_date=None, repository=None, serialization_format=None, short_name=None, specification_format=None, support_channel=None, type=None, version_identifier=None, version_innovation=None):
        return super().__init__(id=id,accessibility=accessibility,copyright=copyright,custodian=custodian,description=description,developer=developer,digital_identifier=digital_identifier,full_documentation=full_documentation,full_name=full_name,funding=funding,homepage=homepage,how_to_cite=how_to_cite,is_alternative_version_of=is_alternative_version_of,is_new_version_of=is_new_version_of,keyword=keyword,license=license,other_contribution=other_contribution,related_publication=related_publication,release_date=release_date,repository=repository,serialization_format=serialization_format,short_name=short_name,specification_format=specification_format,support_channel=support_channel,type=type,version_identifier=version_identifier,version_innovation=version_innovation,)
