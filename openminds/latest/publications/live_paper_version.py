...
class LivePaperVersion(LinkedMetadata):
    ...
    properties = [
        Property(
            "about",
            ['openminds.latest.core.DatasetVersion', 'openminds.latest.core.ModelVersion', 'openminds.latest.core.SoftwareVersion'],
            "vocab:about",
            multiple=True,
            unique_items=True,
            min_items=1,
    ...
    def __init__(self, id=None, about=None, accessibility=None, author=None, copyright=None, custodian=None, description=None, digital_identifier=None, full_documentation=None, full_name=None, funding=None, homepage=None, how_to_cite=None, is_alternative_version_of=None, is_new_version_of=None, keyword=None, license=None, modification_date=None, other_contribution=None, related_publication=None, release_date=None, repository=None, short_name=None, support_channel=None, version_identifier=None, version_innovation=None):
        return super().__init__(id=id,about=about,accessibility=accessibility,author=author,copyright=copyright,custodian=custodian,description=description,digital_identifier=digital_identifier,full_documentation=full_documentation,full_name=full_name,funding=funding,homepage=homepage,how_to_cite=how_to_cite,is_alternative_version_of=is_alternative_version_of,is_new_version_of=is_new_version_of,keyword=keyword,license=license,modification_date=modification_date,other_contribution=other_contribution,related_publication=related_publication,release_date=release_date,repository=repository,short_name=short_name,support_channel=support_channel,version_identifier=version_identifier,version_innovation=version_innovation,)
