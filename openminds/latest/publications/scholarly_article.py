...
class ScholarlyArticle(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "is_part_of",
            ['openminds.latest.publications.PublicationIssue', 'openminds.latest.publications.PublicationVolume'],
        ...
        Property(
            "pagination",
            str,
            "vocab:pagination",formatting="text/plain",
    ...
    def __init__(self, id=None, iri=None, abstract=None, author=None, cited_publication=None, copyright=None, creation_date=None, custodian=None, digital_identifier=None, editor=None, funding=None, is_part_of=None, keyword=None, license=None, modification_date=None, name=None, pagination=None, publication_date=None, publisher=None, version_identifier=None):
        return super().__init__(id=id,iri=iri,abstract=abstract,author=author,cited_publication=cited_publication,copyright=copyright,creation_date=creation_date,custodian=custodian,digital_identifier=digital_identifier,editor=editor,funding=funding,is_part_of=is_part_of,keyword=keyword,license=license,modification_date=modification_date,name=name,pagination=pagination,publication_date=publication_date,publisher=publisher,version_identifier=version_identifier,)
