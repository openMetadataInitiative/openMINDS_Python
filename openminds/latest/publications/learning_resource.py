...
class LearningResource(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "abstract",
            str,
            "vocab:abstract",formatting="text/plain",
            multiline=True,
        ...
        Property(
            "learning_outcome",
            str,
            "vocab:learningOutcome",formatting="text/markdown",
            multiline=True,
        ...
        Property(
            "prerequisite",
            str,
            "vocab:prerequisite",formatting="text/markdown",
            multiline=True,
        ...
        Property(
            "publication_date",
            date,
            "vocab:publicationDate",required=True,
            description="no description available",
        ...
        Property(
            "topic",
            str,
            "vocab:topic",formatting="text/plain",
    ...
    def __init__(self, id=None, iri=None, about=None, abstract=None, author=None, cited_publication=None, copyright=None, creation_date=None, custodian=None, digital_identifier=None, editor=None, educational_level=None, funding=None, keyword=None, learning_outcome=None, license=None, modification_date=None, name=None, order=None, prerequisite=None, publication_date=None, publisher=None, required_time=None, topic=None, type=None, version_identifier=None):
        return super().__init__(id=id,iri=iri,about=about,abstract=abstract,author=author,cited_publication=cited_publication,copyright=copyright,creation_date=creation_date,custodian=custodian,digital_identifier=digital_identifier,editor=editor,educational_level=educational_level,funding=funding,keyword=keyword,learning_outcome=learning_outcome,license=license,modification_date=modification_date,name=name,order=order,prerequisite=prerequisite,publication_date=publication_date,publisher=publisher,required_time=required_time,topic=topic,type=type,version_identifier=version_identifier,)
