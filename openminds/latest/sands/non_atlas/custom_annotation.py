...
class CustomAnnotation(EmbeddedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:criteriaType",required=True,
            description="no description available",
        ...
        Property(
            "specification",
            ['openminds.latest.core.File', 'openminds.latest.core.PropertyValueList'],
            "vocab:specification",
    ...
    def __init__(self, anchor_point=None, coordinate_space=None, criteria=None, criteria_quality_type=None, criteria_type=None, inspired_by=None, internal_identifier=None, laterality=None, preferred_visualization=None, specification=None, type=None):
        return super().__init__(anchor_point=anchor_point,coordinate_space=coordinate_space,criteria=criteria,criteria_quality_type=criteria_quality_type,criteria_type=criteria_type,inspired_by=inspired_by,internal_identifier=internal_identifier,laterality=laterality,preferred_visualization=preferred_visualization,specification=specification,type=type,)
