...
class BrainAtlasVersion(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:hasTerminology",required=True,
            description="no description available",
        ...
        Property(
            ...
            str,
            "vocab:majorVersionIdentifier",formatting="text/plain",
    ...
    def __init__(self, id=None, abbreviation=None, accessibility=None, author=None, coordinate_space=None, copyright=None, custodian=None, description=None, digital_identifier=None, full_documentation=None, full_name=None, funding=None, has_terminology=None, homepage=None, how_to_cite=None, is_alternative_version_of=None, is_new_version_of=None, keyword=None, license=None, major_version_identifier=None, ontology_identifier=None, other_contribution=None, related_publication=None, release_date=None, repository=None, short_name=None, support_channel=None, type=None, used_specimen=None, version_identifier=None, version_innovation=None):
        return super().__init__(id=id,abbreviation=abbreviation,accessibility=accessibility,author=author,coordinate_space=coordinate_space,copyright=copyright,custodian=custodian,description=description,digital_identifier=digital_identifier,full_documentation=full_documentation,full_name=full_name,funding=funding,has_terminology=has_terminology,homepage=homepage,how_to_cite=how_to_cite,is_alternative_version_of=is_alternative_version_of,is_new_version_of=is_new_version_of,keyword=keyword,license=license,major_version_identifier=major_version_identifier,ontology_identifier=ontology_identifier,other_contribution=other_contribution,related_publication=related_publication,release_date=release_date,repository=repository,short_name=short_name,support_channel=support_channel,type=type,used_specimen=used_specimen,version_identifier=version_identifier,version_innovation=version_innovation,)
