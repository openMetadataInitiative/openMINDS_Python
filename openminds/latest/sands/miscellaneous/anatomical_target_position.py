...
class AnatomicalTargetPosition(EmbeddedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:targetIdentificationType",required=True,
            description="no description available",
    ...
    def __init__(self, additional_remarks=None, anatomical_target=None, spatial_location=None, target_identification_type=None):
        return super().__init__(additional_remarks=additional_remarks,anatomical_target=anatomical_target,spatial_location=spatial_location,target_identification_type=target_identification_type,)
