...
class GustatoryStimulusType(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the gustatory stimulus type.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the gustatory stimulus type.",
...
from . import gustatory_stimulus_type_instances as _  # noqa: F401
