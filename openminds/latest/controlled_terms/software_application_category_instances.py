...
from openminds.latest.controlled_terms.software_application_category import SoftwareApplicationCategory
...
SoftwareApplicationCategory.application = SoftwareApplicationCategory(
    ...
    name="application",
    preferred_cross_reference=IRI("https://www.wikidata.org/entity/Q166142"),
)
...
SoftwareApplicationCategory.library = SoftwareApplicationCategory(
    ...
    name="library",
    preferred_cross_reference=IRI("https://www.wikidata.org/entity/Q188860"),
)
...
SoftwareApplicationCategory.middleware = SoftwareApplicationCategory(
    ...
    name="middleware",
    preferred_cross_reference=IRI("https://www.wikidata.org/entity/Q146768"),
)
...
SoftwareApplicationCategory.module = SoftwareApplicationCategory(
    ...
    name="module",
    preferred_cross_reference=IRI("https://www.wikidata.org/entity/Q11883090"),
)
...
SoftwareApplicationCategory.notebook = SoftwareApplicationCategory(
    ...
    name="notebook",
    preferred_cross_reference=IRI("https://www.wikidata.org/entity/Q28405706"),
)
...
SoftwareApplicationCategory.plugin = SoftwareApplicationCategory(
    ...
    name="plugin",
    preferred_cross_reference=IRI("https://www.wikidata.org/entity/Q184148"),
)
