...
class OperatingSystem(LinkedMetadata):
    """
    Structured information on the operating system.
    """
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the operating system.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the operating system.",
