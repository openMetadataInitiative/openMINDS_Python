...
class SkeletalStructure(LinkedMetadata):
    """
    <description not available>
    """
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the skeletal structure.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the skeletal structure.",
...
SkeletalStructure.femur = SkeletalStructure(
    ...
    name="femur",
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/UBERON_0000981"),
)
