...
class AuditoryStimulusType(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the auditory stimulus type.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the auditory stimulus type.",
...
from . import auditory_stimulus_type_instances as _  # noqa: F401
