...
class DataCopy(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "input",
            ['openminds.latest.computation.LocalFile', 'openminds.latest.computation.ValidationTestVersion', 'openminds.latest.core.DatasetVersion', 'openminds.latest.core.File', 'openminds.latest.core.FileBundle', 'openminds.latest.core.ModelVersion', 'openminds.latest.core.SoftwareVersion'],
            "vocab:input",
            multiple=True,
            unique_items=True,
            min_items=1,
        ...
        Property(
            "output",
            ['openminds.latest.computation.LocalFile', 'openminds.latest.core.File', 'openminds.latest.core.FileBundle'],
            "vocab:output",
            multiple=True,
            unique_items=True,
            min_items=1,
