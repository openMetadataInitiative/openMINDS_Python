...
class WorkflowRecipe(LinkedMetadata):
    """
    Structured information about the description of a prospective workflow.
    """
    ...
    properties = [
        ...
        Property(
            ...
            multiline=True,
            required=True,
            description="Longer statement or account giving the characteristics of the workflow recipe.",
        ...
        Property(
            ...
            required=True,
            description="Whole, non-abbreviated name of the workflow recipe.",
        ...
        Property(
            ...
            IRI,
            "homepage",
            description="Main website of the workflow recipe.",
        ...
        Property(
            ...
            formatting="text/plain",
            required=True,
            description="Shortened or fully abbreviated name of the workflow recipe.",
