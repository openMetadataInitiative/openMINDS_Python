...
class ValidationTest(LinkedMetadata):
    ...
    def __init__(self, id=None, custodian=None, description=None, developer=None, digital_identifier=None, full_name=None, has_version=None, homepage=None, how_to_cite=None, reference_data_acquisition=None, scope=None, score_type=None, short_name=None, study_target=None):
        return super().__init__(id=id,custodian=custodian,description=description,developer=developer,digital_identifier=digital_identifier,full_name=full_name,has_version=has_version,homepage=homepage,how_to_cite=how_to_cite,reference_data_acquisition=reference_data_acquisition,scope=scope,score_type=score_type,short_name=short_name,study_target=study_target,)
