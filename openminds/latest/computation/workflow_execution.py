...
class WorkflowExecution(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "stage",
            ['openminds.latest.computation.DataAnalysis', 'openminds.latest.computation.DataCopy', 'openminds.latest.computation.GenericComputation', 'openminds.latest.computation.ModelValidation', 'openminds.latest.computation.Optimization', 'openminds.latest.computation.Simulation', 'openminds.latest.computation.Visualization'],
            "vocab:stage",
            multiple=True,
            unique_items=True,
            min_items=1,
    ...
    def __init__(self, id=None, configuration=None, recipe=None, stage=None, started_by=None):
        return super().__init__(id=id,configuration=configuration,recipe=recipe,stage=stage,started_by=started_by,)
