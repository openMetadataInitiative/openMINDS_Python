...
class LocalFile(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "path",
            str,
            "vocab:path",formatting="text/plain",
    ...
    def __init__(self, id=None, content_description=None, copy_of=None, data_type=None, format=None, hash=None, name=None, path=None, special_usage_role=None, storage_size=None):
        return super().__init__(id=id,content_description=content_description,copy_of=copy_of,data_type=data_type,format=format,hash=hash,name=name,path=path,special_usage_role=special_usage_role,storage_size=storage_size,)
