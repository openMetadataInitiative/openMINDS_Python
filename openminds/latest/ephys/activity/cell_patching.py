...
class CellPatching(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "device",
            ['openminds.latest.ephys.ElectrodeArrayUsage', 'openminds.latest.ephys.ElectrodeUsage', 'openminds.latest.ephys.PipetteUsage', 'openminds.latest.specimen_prep.SlicingDeviceUsage'],
            "vocab:device",
            multiple=True,
            unique_items=True,
            min_items=1,
    ...
    def __init__(self, id=None, bath_temperature=None, custom_property_set=None, description=None, device=None, end_time=None, input=None, is_part_of=None, lookup_label=None, output=None, performed_by=None, preparation_design=None, protocol=None, start_time=None, study_target=None, target_position=None, tissue_bath_solution=None, variation=None):
        return super().__init__(id=id,bath_temperature=bath_temperature,custom_property_set=custom_property_set,description=description,device=device,end_time=end_time,input=input,is_part_of=is_part_of,lookup_label=lookup_label,output=output,performed_by=performed_by,preparation_design=preparation_design,protocol=protocol,start_time=start_time,study_target=study_target,target_position=target_position,tissue_bath_solution=tissue_bath_solution,variation=variation,)
