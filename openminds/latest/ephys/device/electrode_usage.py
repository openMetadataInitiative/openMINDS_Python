...
class ElectrodeUsage(LinkedMetadata):
    ...
    def __init__(self, id=None, anatomical_location=None, contact_resistance=None, device=None, lookup_label=None, metadata_location=None, spatial_location=None, used_specimen=None):
        return super().__init__(id=id,anatomical_location=anatomical_location,contact_resistance=contact_resistance,device=device,lookup_label=lookup_label,metadata_location=metadata_location,spatial_location=spatial_location,used_specimen=used_specimen,)
