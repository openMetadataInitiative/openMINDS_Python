...
class ElectrodeArrayUsage(LinkedMetadata):
    ...
    def __init__(self, id=None, anatomical_location_of_array=None, anatomical_location_of_electrodes=None, contact_resistances=None, device=None, lookup_label=None, metadata_location=None, spatial_location_of_electrodes=None, used_electrode=None, used_specimen=None):
        return super().__init__(id=id,anatomical_location_of_array=anatomical_location_of_array,anatomical_location_of_electrodes=anatomical_location_of_electrodes,contact_resistances=contact_resistances,device=device,lookup_label=lookup_label,metadata_location=metadata_location,spatial_location_of_electrodes=spatial_location_of_electrodes,used_electrode=used_electrode,used_specimen=used_specimen,)
