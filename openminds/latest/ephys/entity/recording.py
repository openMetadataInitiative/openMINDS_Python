...
class Recording(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:dataLocation",required=True,
            description="no description available",
        ...
        Property(
            ...
            "vocab:recordedWith",required=True,
            description="no description available",
        ...
        Property(
            ...
            "vocab:samplingFrequency",required=True,
            description="no description available",
    ...
    def __init__(self, id=None, additional_remarks=None, channel=None, data_location=None, internal_identifier=None, name=None, previous_recording=None, recorded_with=None, sampling_frequency=None):
        return super().__init__(id=id,additional_remarks=additional_remarks,channel=channel,data_location=data_location,internal_identifier=internal_identifier,name=name,previous_recording=previous_recording,recorded_with=recorded_with,sampling_frequency=sampling_frequency,)
