...
class SlicingDeviceUsage(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            "vocab:sliceThickness",required=True,
            description="no description available",
        ...
        Property(
            ...
            "vocab:slicingPlane",required=True,
            description="no description available",
    ...
    def __init__(self, id=None, device=None, lookup_label=None, metadata_location=None, oscillation_amplitude=None, slice_thickness=None, slicing_angle=None, slicing_plane=None, slicing_speed=None, used_specimen=None, vibration_frequency=None):
        return super().__init__(id=id,device=device,lookup_label=lookup_label,metadata_location=metadata_location,oscillation_amplitude=oscillation_amplitude,slice_thickness=slice_thickness,slicing_angle=slicing_angle,slicing_plane=slicing_plane,slicing_speed=slicing_speed,used_specimen=used_specimen,vibration_frequency=vibration_frequency,)
