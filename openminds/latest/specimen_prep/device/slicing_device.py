...
class SlicingDevice(LinkedMetadata):
    ...
    def __init__(self, id=None, description=None, device_type=None, digital_identifier=None, lookup_label=None, manufacturer=None, name=None, owner=None, serial_number=None):
        return super().__init__(id=id,description=description,device_type=device_type,digital_identifier=digital_identifier,lookup_label=lookup_label,manufacturer=manufacturer,name=name,owner=owner,serial_number=serial_number,)
