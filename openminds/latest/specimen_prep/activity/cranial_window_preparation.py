...
class CranialWindowPreparation(LinkedMetadata):
    ...
    properties = [
        Property(
            ...
            "vocab:constructionType",required=True,
    ...
    def __init__(self, id=None, construction_type=None, custom_property_set=None, description=None, dimension=None, end_time=None, input=None, is_part_of=None, lookup_label=None, output=None, performed_by=None, preparation_design=None, protocol=None, reinforcement_type=None, start_time=None, study_target=None):
        return super().__init__(id=id,construction_type=construction_type,custom_property_set=custom_property_set,description=description,dimension=dimension,end_time=end_time,input=input,is_part_of=is_part_of,lookup_label=lookup_label,output=output,performed_by=performed_by,preparation_design=preparation_design,protocol=protocol,reinforcement_type=reinforcement_type,start_time=start_time,study_target=study_target,)
