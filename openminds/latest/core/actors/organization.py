...
class Organization(LinkedMetadata):
    ...
    def __init__(self, id=None, affiliation=None, digital_identifier=None, full_name=None, has_parent=None, homepage=None, short_name=None):
        return super().__init__(id=id,affiliation=affiliation,digital_identifier=digital_identifier,full_name=full_name,has_parent=has_parent,homepage=homepage,short_name=short_name,)
