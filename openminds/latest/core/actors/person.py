...
class Person(LinkedMetadata):
    ...
    def __init__(self, id=None, affiliation=None, alternate_name=None, associated_account=None, contact_information=None, digital_identifier=None, family_name=None, given_name=None):
        return super().__init__(id=id,affiliation=affiliation,alternate_name=alternate_name,associated_account=associated_account,contact_information=contact_information,digital_identifier=digital_identifier,family_name=family_name,given_name=given_name,)
