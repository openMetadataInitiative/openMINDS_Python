...
class FileRepository(LinkedMetadata):
    ...
    def __init__(self, id=None, iri=None, content_type_pattern=None, format=None, hash=None, hosted_by=None, name=None, storage_size=None, structure_pattern=None, type=None):
        return super().__init__(id=id,iri=iri,content_type_pattern=content_type_pattern,format=format,hash=hash,hosted_by=hosted_by,name=name,storage_size=storage_size,structure_pattern=structure_pattern,type=type,)
