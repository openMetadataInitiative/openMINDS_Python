...
class ContentType(LinkedMetadata):
    ...
    def __init__(self, id=None, data_type=None, description=None, display_label=None, file_extension=None, name=None, related_media_type=None, specification=None, synonym=None):
        return super().__init__(id=id,data_type=data_type,description=description,display_label=display_label,file_extension=file_extension,name=name,related_media_type=related_media_type,specification=specification,synonym=synonym,)
