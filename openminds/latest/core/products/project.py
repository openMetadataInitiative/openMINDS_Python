...
class Project(LinkedMetadata):
    ...
    def __init__(self, id=None, coordinator=None, description=None, full_name=None, has_part=None, homepage=None, short_name=None):
        return super().__init__(id=id,coordinator=coordinator,description=description,full_name=full_name,has_part=has_part,homepage=homepage,short_name=short_name,)
