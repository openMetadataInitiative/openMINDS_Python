...
class Interface(LinkedMetadata):
    """
    <description not available>
    """
    ...
    properties = [
        ...
        Property(
            ...
            multiline=True,
            required=True,
            description="Longer statement or account giving the characteristics of the interface.",
        ...
        Property(
            ...
            required=True,
            description="Whole, non-abbreviated name of the interface.",
        ...
        Property(
            ...
            IRI,
            "homepage",
            description="Main website of the interface.",
        ...
        Property(
            ...
            unique_items=True,
            min_items=1,
            description="Significant word or concept that are representative of the interface.",
        ...
        Property(
            ...
            formatting="text/plain",
            required=True,
            description="Shortened or fully abbreviated name of the interface.",
