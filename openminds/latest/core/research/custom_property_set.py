...
class CustomPropertySet(EmbeddedMetadata):
    ...
    properties = [
        ...
        Property(
            "data_location",
            ['openminds.latest.core.Configuration', 'openminds.latest.core.File', 'openminds.latest.core.PropertyValueList'],
    ...
    def __init__(self, context=None, data_location=None, relevant_for=None):
        return super().__init__(context=context,data_location=data_location,relevant_for=relevant_for,)
