...
class Subject(LinkedMetadata):
    ...
    def __init__(self, id=None, biological_sex=None, internal_identifier=None, is_part_of=None, lookup_label=None, species=None, studied_state=None):
        return super().__init__(id=id,biological_sex=biological_sex,internal_identifier=internal_identifier,is_part_of=is_part_of,lookup_label=lookup_label,species=species,studied_state=studied_state,)
