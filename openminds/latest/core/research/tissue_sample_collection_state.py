...
class TissueSampleCollectionState(LinkedMetadata):
    ...
    def __init__(self, id=None, additional_remarks=None, age=None, attribute=None, descended_from=None, internal_identifier=None, lookup_label=None, pathology=None, relative_time_indication=None, weight=None):
        return super().__init__(id=id,additional_remarks=additional_remarks,age=age,attribute=attribute,descended_from=descended_from,internal_identifier=internal_identifier,lookup_label=lookup_label,pathology=pathology,relative_time_indication=relative_time_indication,weight=weight,)
