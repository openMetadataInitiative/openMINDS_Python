...
class BiologicalSex(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the biological sex.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the biological sex.",
        ...
        Property(
            ...
            IRI,
            "ontologyIdentifier",
            description="Term or code used to identify the biological sex registered within a particular ontology.",
