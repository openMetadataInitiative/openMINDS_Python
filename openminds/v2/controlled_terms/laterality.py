...
class Laterality(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the laterality.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the laterality.",
        ...
        Property(
            ...
            IRI,
            "ontologyIdentifier",
            description="Term or code used to identify the laterality registered within a particular ontology.",
