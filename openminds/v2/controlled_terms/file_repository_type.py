...
class FileRepositoryType(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the file repository type.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the file repository type.",
        ...
        Property(
            ...
            IRI,
            "ontologyIdentifier",
            description="Term or code used to identify the file repository type registered within a particular ontology.",
