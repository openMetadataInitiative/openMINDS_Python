...
class BehavioralTask(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the behavioral task.",
        ...
        Property(
            ...
            IRI,
            "ontologyIdentifier",
            description="Term or code used to identify the behavioral task registered within a particular ontology.",
