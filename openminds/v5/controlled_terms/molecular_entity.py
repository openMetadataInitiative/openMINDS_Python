...
class MolecularEntity(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the molecular entity.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the molecular entity.",
...
MolecularEntity.a1_receptor = MolecularEntity(
    ...
    name="A1 receptor",
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5717"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0100146"),
...
MolecularEntity.a2_a_receptor = MolecularEntity(
    ...
    name="A2A receptor",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_7727"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:7728#a2a-receptor"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0100148"),
...
MolecularEntity.acetylcholine = MolecularEntity(
    ...
    name="acetylcholine",
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/sao185580330"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0100240"),
    synonyms=["ACh"],
)
MolecularEntity.alexa_fluor594 = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:51248#alexa-fluor-594"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_51248"),
    synonyms=["Alexa 594"],
)
...
MolecularEntity.alpha_4_beta_2_receptor = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0597802"],
    preferred_ontology_identifier=IRI("http://id.nlm.nih.gov/mesh/2018/M0356600"),
    synonyms=[
...
MolecularEntity.ampa_receptor = MolecularEntity(
    ...
    name="AMPA receptor",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_5251"],
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/NIFEXT:5251#ampa-type-glutamate-gated-cationic-channel"
    ),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0100559"),
    synonyms=[
...
MolecularEntity.anterograde_tracer = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:1012002#anterograde-tracer"),
...
MolecularEntity.atp = MolecularEntity(
    ...
    name="ATP",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0780796"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:15422#atp"),
...
MolecularEntity.beta__amyloid40 = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_13181"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:20090708#beta-amyloid-40"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0101246"),
...
MolecularEntity.biomarker = MolecularEntity(
    ...
    name="biomarker",
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090517"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0101294"),
)
MolecularEntity.biotinylated_dextran_amine = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0450726"],
    preferred_ontology_identifier=IRI("http://id.nlm.nih.gov/mesh/2018/M0205506"),
...
MolecularEntity.brain_derived_neurotrophic_factor = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0101140"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:20090401#bdnf"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0101140"),
...
MolecularEntity.c_fos = MolecularEntity(
    ...
    name="c-FOS",
    other_cross_references=[
        "https://ncimeta.nci.nih.gov/ncimbrowser/ConceptReport.jsp?dictionary=NCI%20Metathesaurus&code=C0314702"
    ],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000007597#proto-oncogene-c-fos"),
...
MolecularEntity.calbindin = MolecularEntity(
    ...
    name="calbindin",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_mol_1006006"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:1006006#calbindin-28k"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0101551"),
...
MolecularEntity.calcium_calmodulin_protein_kinase_ii = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0101561"],
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/PR:000003197#calcium-calmodulin-dependent-protein-kinase-ii-chain"
    ),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000003197"),
    synonyms=[
...
MolecularEntity.calcium_calmodulin_protein_kinase_ii_alpha_chain = MolecularEntity(
    ...
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/PR:000003199#calcium-calmodulin-dependent-protein-kinase-type-ii-alpha-chain"
    ),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000003199"),
    synonyms=[
...
MolecularEntity.calcium_chloride = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0101566"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:3312#calcium-dichloride"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_3312"),
...
MolecularEntity.calretinin = MolecularEntity(
    ...
    name="calretinin",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_5717"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:5#calretinin"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0101602"),
...
MolecularEntity.carbon_dioxide = MolecularEntity(
    ...
    name="carbon dioxide",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0780969"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:16526#carbon-dioxide"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_16526"),
    synonyms=[
        "CO2",
        "carbonic acid gas",
        "carbonic anhydride",
...
MolecularEntity.cesium_sulfate = MolecularEntity(
    ...
    name="cesium sulfate",
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/25137"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0514068"),
    synonyms=[
        "caesium sulfate",
        "caesium sulphate",
        "cesium sulphate",
...
MolecularEntity.cholecystokinin = MolecularEntity(
    ...
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5068"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0102124"),
    synonyms=["CCK"],
)
MolecularEntity.choline = MolecularEntity(
    ...
    name="choline",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0102128"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:15354#choline"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_15354"),
    synonyms=[
...
MolecularEntity.choline_acetyltransferase = MolecularEntity(
    ...
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/sao722953401"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0102129"),
...
MolecularEntity.cyclic_adenosine_monophosphate = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0100318"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:17489#3-5-cyclic-amp"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_17489"),
    synonyms=[
        "3',5'-cyclic AMP",
...
MolecularEntity.d1_receptor = MolecularEntity(
    ...
    name="D1 receptor",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_5845"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:5845#d1-receptor-1"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0102774"),
...
MolecularEntity.d2_receptor = MolecularEntity(
    ...
    name="D2 receptor",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_5833"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:5833#d2-receptor-3"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0102775"),
...
MolecularEntity.d_ap5 = MolecularEntity(
    ...
    name="D-AP5",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0100867"],
...
MolecularEntity.dab = MolecularEntity(
    ...
    name="DAB",
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0482636"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:90994#3-3-diaminobenzidine"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_90994"),
...
MolecularEntity.diboron_trioxide = MolecularEntity(
    ...
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_30163"),
...
MolecularEntity.dimethyl_sulfoxide = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0103278"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:28262#dimethyl-sulfoxide"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_28262"),
    synonyms=[
        "DMSO",
...
MolecularEntity.dinitrogen = MolecularEntity(
    ...
    name="dinitrogen",
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_17997"),
...
MolecularEntity.dioxygen = MolecularEntity(
    ...
    name="dioxygen",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0398707"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:15379#dioxygen"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_15379"),
...
MolecularEntity.dopamine = MolecularEntity(
    ...
    name="dopamine",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0103384"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:18243#dopamine"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_18243"),
...
MolecularEntity.dopamine_transporter = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0103388"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:20090512#dopamine-transporter"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000015188"),
...
MolecularEntity.dynorphin = MolecularEntity(
    ...
    name="dynorphin",
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5097"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0103624"),
    synonyms=["Dyn"],
)
MolecularEntity.edetic_acid = MolecularEntity(
    ...
    name="edetic acid",
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/CHEBI:4735#ethylene-glycol-bis-2-aminoethyl-tetraacetic-acid"
    ),
...
MolecularEntity.egtazic_acid = MolecularEntity(
    ...
    name="egtazic acid",
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/CHEBI:30740#ethylene-glycol-bis-2-aminoethyl-tetraacetic-acid"
    ),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_30740"),
    synonyms=[
...
MolecularEntity.enkephalin = MolecularEntity(
    ...
    name="enkephalin",
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5096"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0103826"),
    synonyms=["Enk"],
)
MolecularEntity.epibatidine = MolecularEntity(
    ...
    name="epibatidine",
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_chem_20090204"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0103884"),
)
MolecularEntity.ethanol = MolecularEntity(
    ...
    name="ethanol",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0103948"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:16236#ethanol"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_16236"),
    synonyms=[
        "absolute alcohol",
        "alcohol",
        "Cologne spirit",
...
MolecularEntity.excitatory_amino_acid_transporter1 = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0103639"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000014974#excitatory-amino-acid-transporter-1"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_0000149744"),
...
MolecularEntity.excitatory_amino_acid_transporter2 = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0103640"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000014973#excitatory-amino-acid-transporter-2"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000014973"),
...
MolecularEntity.excitatory_amino_acid_transporter3 = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0103641"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000014972#excitatory-amino-acid-transporter-3"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000014972"),
    synonyms=["EAAT3"],
)
MolecularEntity.excitatory_amino_acid_transporter4 = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0103642"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000014977#excitatory-amino-acid-transporter-4"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000014977"),
    synonyms=["EAAT4"],
)
MolecularEntity.excitatory_amino_acid_transporter5 = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000014978#excitatory-amino-acid-transporter-5"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000014978"),
    synonyms=["EAAT5"],
)
MolecularEntity.five_ht1_a_receptor = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_5890"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:5891#5-ht1a-receptor-2"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0100033"),
...
MolecularEntity.five_ht1_b_receptor = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_6386"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:6386#5-ht1b-receptor-3"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0100034"),
...
MolecularEntity.five_ht2_a_receptor = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_6741"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:6742#5-ht2a-receptor-1"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0100038"),
...
MolecularEntity.five_ht2_receptor = MolecularEntity(
    ...
    name="5-HT2 receptor",
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0492260"],
    preferred_ontology_identifier=IRI("http://id.nlm.nih.gov/mesh/2018/M0018621"),
...
MolecularEntity.five_ht4_receptor = MolecularEntity(
    ...
    name="5-HT4 receptor",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_6151"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:6151#5-ht4-receptor-1"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0100041"),
...
MolecularEntity.five_ht_transporter = MolecularEntity(
    ...
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/PR:000015189#sodium-dependent-serotonin-transporter"
    ),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000015189"),
...
MolecularEntity.flumazenil = MolecularEntity(
    ...
    name="flumazenil",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0104307"],
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_5103"),
)
...
MolecularEntity.fluoro__gold = MolecularEntity(
    ...
    name="Fluoro-Gold",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_30125"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:1012018#fluorogold"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0104323"),
...
MolecularEntity.fluoro__ruby = MolecularEntity(
    ...
    name="Fluoro-Ruby",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_65982"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLX:65982#fluoro-ruby"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0104322"),
...
MolecularEntity.formaldehyde = MolecularEntity(
    ...
    name="formaldehyde",
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:16842#formaldehyde"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_16842"),
    synonyms=[
        "methyl aldehyde",
        "methylene glycol",
        "methylene oxide",
...
MolecularEntity.four_2_hydroxyethyl_1_piperazine_ethanesulfonic_acid = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0484759"],
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/CHEBI:42334#2-4-2-hydroxyethyl-piperazin-1-yl-ethanesulfonic-acid"
    ),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_42334"),
    synonyms=["HEPES", "2-[4-(2-hydroxyethyl)piperazin-1-yl]ethane-1-sulfonic acid"],
)
MolecularEntity.gaba_a_bz = MolecularEntity(
...
MolecularEntity.gaba_receptor = MolecularEntity(
    ...
    name="GABA receptor",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_mol_1006001"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/GO:1902710#gaba-receptor-complex"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0104502"),
...
MolecularEntity.gabazine = MolecularEntity(
    ...
    name="gabazine",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0572043"],
...
MolecularEntity.gadolinium = MolecularEntity(
    ...
    name="gadolinium",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0782820"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:35729#gadolinium-molecular-entity"),
...
MolecularEntity.galanin = MolecularEntity(
    ...
    name="galanin",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_5074"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:5074#galanin"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0104529"),
    synonyms=["GAL"],
)
MolecularEntity.gluconic_acid = MolecularEntity(
    ...
    name="gluconic acid",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0402003"],
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_33198"),
...
MolecularEntity.glucose = MolecularEntity(
    ...
    name="glucose",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0104670"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:17234#glucose"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_17234"),
...
MolecularEntity.glutamate = MolecularEntity(
    ...
    name="glutamate",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/sao1744435799"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/SAO:1744435799#glutamate"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0104676"),
...
MolecularEntity.glutamate_transporter = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/sao1399894198"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/SAO:1399894198#glutamate-transporter"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0104678"),
    synonyms=["GLT"],
)
MolecularEntity.glycerol = MolecularEntity(
    ...
    name="glycerol",
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:17754#glycerol"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_17754"),
...
MolecularEntity.glycine_transporter2 = MolecularEntity(
    ...
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/PR:000015190#sodium-and-chloride-dependent-glycine-transporter-2"
    ),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000015190"),
...
MolecularEntity.growth_factor = MolecularEntity(
    ...
    name="growth factor",
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/sao1671627152"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0104801"),
    synonyms=["GF"],
)
MolecularEntity.gtp = MolecularEntity(
    ...
    name="GTP",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0439625"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:15996#gtp"),
...
MolecularEntity.gtp_disodium_salt = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/135818278"),
    synonyms=[
...
MolecularEntity.halothane = MolecularEntity(
    ...
    name="halothane",
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/3562"),
    synonyms=[
...
MolecularEntity.histamine = MolecularEntity(
    ...
    name="histamine",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_5016"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:5016#histamine"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0105065"),
)
MolecularEntity.insulin_like_growth_factor1 = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0105523"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000009182#insulin-like-growth-factor-i"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0105523"),
...
MolecularEntity.iodine = MolecularEntity(
    ...
    name="iodine",
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:24860#iodine-molecular-entity"),
...
MolecularEntity.ionotropic_glutamate_receptor = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090501"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:20090501#ionotropic-glutamate-receptor"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0105706"),
    synonyms=["iGluR"],
)
MolecularEntity.iperoxo = MolecularEntity(
    ...
    name="iperoxo",
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0630403"],
    preferred_ontology_identifier=IRI("http://id.nlm.nih.gov/mesh/2018/M000598130"),
...
MolecularEntity.iron = MolecularEntity(
    ...
    name="iron",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0105721"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:24873#iron-molecular-entity"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_24873"),
    synonyms=["Fe", "Ferrum"],
)
MolecularEntity.isoflurane = MolecularEntity(
    ...
    name="isoflurane",
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0105740"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:6015#isoflurane"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_6015"),
...
MolecularEntity.jnk_map_kinase_scaffold_protein2 = MolecularEntity(
    ...
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/PR:000010161#c-jun-amino-terminal-kinase-interacting-protein-2"
    ),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000010161"),
    synonyms=[
...
MolecularEntity.kainate_receptor = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_5252"],
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/NIFEXT:5252#kainate-glutamate-gated-cationic-channel"
    ),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0105822"),
    synonyms=[
...
MolecularEntity.kallikrein_related_peptidase8 = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000009614#kallikrein-1-related-peptidase-b8"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000009614"),
...
MolecularEntity.ketamine = MolecularEntity(
    ...
    name="ketamine",
    other_cross_references=["https://www.drugbank.ca/drugs/DB01221"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFSTD:DB01221#ketamine"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0105850"),
    synonyms=[
        "(-)-ketamine",
        "(S)-(-)-ketamine",
        "(S)-ketamine",
...
MolecularEntity.lucifer_yellow = MolecularEntity(
    ...
    name="lucifer yellow",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0439021"],
    preferred_ontology_identifier=IRI("http://id.nlm.nih.gov/mesh/2018/M0068243"),
    synonyms=["LY"],
)
MolecularEntity.m1_receptor = MolecularEntity(
    ...
    name="M1 receptor",
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0106429"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:7352#m1-receptor-1"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000001613"),
    synonyms=[
...
MolecularEntity.m2_receptor = MolecularEntity(
    ...
    name="M2 receptor",
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0106430"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:7953#m2-receptor-2"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000001614"),
    synonyms=[
        "M2",
...
MolecularEntity.m3_receptor = MolecularEntity(
    ...
    name="M3 receptor",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_6131"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:6135#m3-receptor"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0106431"),
    synonyms=[
        "M3",
...
MolecularEntity.magnesium_atp = MolecularEntity(
    ...
    name="magnesium ATP",
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/15126"),
    synonyms=["MgATP"],
)
MolecularEntity.magnesium_chloride = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:6636#magnesium-dichloride"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_6636"),
    synonyms=["MgCl2", "E511"],
)
MolecularEntity.magnesium_sulfate = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0106452"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:32599#magnesium-sulfate"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_32599"),
    synonyms=[
        "MgSO4",
        "bitter salt",
        "bath salt",
...
MolecularEntity.medetomidine = MolecularEntity(
    ...
    name="medetomidine",
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0488544"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:48552#medetomidine"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_48552"),
)
MolecularEntity.metabotropic_glutamate_receptor = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090503"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:20090503#metabotropic-glutamate-receptor"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0106829"),
...
MolecularEntity.metabotropic_glutamate_receptor1 = MolecularEntity(
    ...
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090504"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0106891"),
...
MolecularEntity.metabotropic_glutamate_receptor2 = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090505"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000008264#metabotropic-glutamate-receptor-2"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0106892"),
...
MolecularEntity.metabotropic_glutamate_receptor3 = MolecularEntity(
    ...
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090506"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000008265#metabotropic-glutamate-receptor-3"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0106893"),
...
MolecularEntity.metabotropic_glutamate_receptor5 = MolecularEntity(
    ...
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090508"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0106895"),
...
MolecularEntity.methanol = MolecularEntity(
    ...
    name="methanol",
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:17790#methanol"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_17790"),
    synonyms=[
        "Carbinol",
        "Columbian spirits",
        "hydroxymethane",
...
MolecularEntity.monosodium_phosphate = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:37585#sodium-dihydrogenphosphate"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_37585"),
    synonyms=[
...
MolecularEntity.muscimol = MolecularEntity(
    ...
    name="muscimol",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0485557"],
    preferred_ontology_identifier=IRI("http://id.nlm.nih.gov/mesh/2018/M0014231"),
    synonyms=["agarin", "pantherine"],
)
MolecularEntity.n_methyl_11c2_4_prime__methylaminophenyl_6_hydroxybenzothiazole = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/2826731"),
    synonyms=[
...
MolecularEntity.neurobiotin = MolecularEntity(
    ...
    name="neurobiotin",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nlx_157299"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:1012015#neurobiotin"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0107453"),
)
MolecularEntity.neuroligin_3 = MolecularEntity(
    ...
    name="neuroligin-3",
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0107485"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000011256#neuroligin-3"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000011256"),
...
MolecularEntity.neuronal_nuclear_antigen = MolecularEntity(
    ...
    preferred_cross_reference=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_152221"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0107517"),
    synonyms=["NeuN"],
)
...
MolecularEntity.nickel = MolecularEntity(
    ...
    name="nickel",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0107575"],
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_28112"),
...
MolecularEntity.nmda_receptor = MolecularEntity(
    ...
    name="NMDA receptor",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_5250"],
    preferred_cross_reference=IRI(
        "https://knowledge-space.org/wiki/NIFEXT:5250#nmda-type-glutamate-gated-cationic-channel"
    ),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0107622"),
    synonyms=[
...
MolecularEntity.parvalbumin = MolecularEntity(
    ...
    name="parvalbumin",
    other_cross_references=["http://uri.neuinfo.org/nif/nifstd/nifext_6"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NIFEXT:6#parvalbumin"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/ilx_0108558"),
    synonyms=["PV", "Pvalb"],
)
MolecularEntity.pentobarbital = MolecularEntity(
    ...
    name="pentobarbital",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0108667"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:7983#pentobarbital"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_7983"),
    synonyms=[
        "pentabarbital",
        "pentabarbitone",
...
MolecularEntity.phosphocreatine_sodium = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/9571077"),
    synonyms=[
...
MolecularEntity.potassium_chloride = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0109170"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:32588#potassium-chloride"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_32588"),
...
MolecularEntity.potassium_gluconate = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:32032#potassium-gluconate"),
...
MolecularEntity.propofol = MolecularEntity(
    ...
    name="propofol",
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0109431"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:44915#propofol"),
...
MolecularEntity.qx_314 = MolecularEntity(
    ...
    name="QX-314",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0523764"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:46937#qx-314"),
...
MolecularEntity.silicon_dioxide = MolecularEntity(
    ...
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_30563"),
    synonyms=[
        "quartz",
        "silica",
        "silicic oxide",
...
MolecularEntity.silver_ammonium = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/57440423"),
    synonyms=[],
)
MolecularEntity.silver_nitrate = MolecularEntity(
    ...
    name="Silver nitrate",
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_32130"),
...
MolecularEntity.sixcomma7_dinitro_1comma4_dihydroquinoxaline_2comma3_dione = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/3899541"),
    preferred_ontology_identifier=IRI("http://uri.interlex.org/base/ilx_0103368"),
...
MolecularEntity.sodium_atp = MolecularEntity(
    ...
    name="sodium ATP",
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/23675355"),
    synonyms=[
        "ATP Na salt",
        "ATP xsodium",
        "ATP-Na",
...
MolecularEntity.sodium_bicarbonate = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:32139#sodium-hydrogencarbonate"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_32139"),
    synonyms=[
        "bicarbonate, sodium",
...
MolecularEntity.sodium_chloride = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:26710#sodium-chloride"),
...
MolecularEntity.sodium_gtp = MolecularEntity(
    ...
    name="sodium GTP",
    preferred_cross_reference=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/136636089"),
    synonyms=[
        "5'-GTP sodium salt",
...
MolecularEntity.sucrose = MolecularEntity(
    ...
    name="sucrose",
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:17992#sucrose"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_17992"),
    synonyms=[
        "Sugar",
...
MolecularEntity.tungsten = MolecularEntity(
    ...
    name="tungsten",
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_27998"),
    synonyms=["wolfram"],
)
...
MolecularEntity.vesicular_glutamate_transporter1 = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0112442"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:1006007#vesicular-glutamate-transporter-1"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000014963"),
    synonyms=["VGLUT1"],
)
MolecularEntity.vesicular_glutamate_transporter2 = MolecularEntity(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0112443"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/NLXMOL:1006009#vesicular-glutamate-transporter-2"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000014962"),
    synonyms=["VGLUT2"],
)
MolecularEntity.vesicular_glutamate_transporter3 = MolecularEntity(
    ...
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/PR:000014964#vesicular-glutamate-transporter-3"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/PR_000014964"),
...
MolecularEntity.water = MolecularEntity(
    ...
    name="water",
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0782172"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/CHEBI:15377#water"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/CHEBI_15377"),
    synonyms=[
        "H2O",
        "hydrogen oxide",
