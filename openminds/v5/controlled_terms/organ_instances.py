...
from openminds.v5.controlled_terms.organ import Organ
...
Organ.insect_adult_brain = Organ(
...
Organ.insect_embryonic_brain = Organ(
...
Organ.insect_embryonic_larval_brain = Organ(
...
Organ.neuroendocrine_gland = Organ(
