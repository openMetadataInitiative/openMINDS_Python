...
class ExternalBodyRegion(LinkedMetadata):
    """
    <description not available>
    """
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the external body region.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the external body region.",
...
from . import external_body_region_instances as _  # noqa: F401
