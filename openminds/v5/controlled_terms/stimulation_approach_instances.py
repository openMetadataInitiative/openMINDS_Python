...
from openminds.v5.controlled_terms.stimulation_approach import StimulationApproach
...
StimulationApproach.auditory_stimulation = StimulationApproach(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0101001"],
...
StimulationApproach.gustatory_stimulation = StimulationApproach(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0104834"],
...
StimulationApproach.interoceptive_stimulation = StimulationApproach(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0105596"],
...
StimulationApproach.olfactory_stimulation = StimulationApproach(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0107962"],
...
StimulationApproach.tactile_stimulation = StimulationApproach(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0111485"],
...
StimulationApproach.visual_stimulation = StimulationApproach(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/ilx_0112525"],
