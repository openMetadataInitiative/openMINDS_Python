...
class OrganSystemStructure(LinkedMetadata):
    """
    <description not available>
    """
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the organ system structure.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the organ system structure.",
...
OrganSystemStructure.adenohypophysis = OrganSystemStructure(
    ...
    other_ontology_identifiers=["http://uri.interlex.org/base/ilx_0100315"],
    preferred_cross_reference=IRI("https://knowledge-space.org/wiki/UBERON:0002196#adenohypophysis-1"),
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/UBERON_0002196"),
    synonyms=[
        "anterior hypophysis",
