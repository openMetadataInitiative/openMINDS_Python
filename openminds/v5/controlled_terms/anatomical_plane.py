...
class AnatomicalPlane(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the anatomical plane.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the anatomical plane.",
...
from . import anatomical_plane_instances as _  # noqa: F401
