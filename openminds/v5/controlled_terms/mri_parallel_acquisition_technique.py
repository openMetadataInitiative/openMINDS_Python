...
class MRIParallelAcquisitionTechnique(LinkedMetadata):
    """
    <description not available>
    """
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the m r i parallel acquisition technique.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the m r i parallel acquisition technique.",
...
from . import mri_parallel_acquisition_technique_instances as _  # noqa: F401
