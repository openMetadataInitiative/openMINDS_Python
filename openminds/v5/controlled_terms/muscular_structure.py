...
class MuscularStructure(LinkedMetadata):
    """
    <description not available>
    """
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the muscular structure.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the muscular structure.",
...
MuscularStructure.pectoral_appendage_muscle = MuscularStructure(
    ...
    preferred_ontology_identifier=IRI("http://purl.obolibrary.org/obo/UBERON_0014794"),
)
