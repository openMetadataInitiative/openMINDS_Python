...
class PatchClampVariation(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the patch clamp variation.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the patch clamp variation.",
...
from . import patch_clamp_variation_instances as _  # noqa: F401
