...
class InterfaceVersion(LinkedMetadata):
    """
    <description not available>
    """
    ...
    properties = [
        Property(
            ...
            "accessibility",
            required=True,
            description="Level to which something is accessible to the interface version.",
        ...
        Property(
            ...
            multiline=True,
            required=True,
            description="Longer statement or account giving the characteristics of the interface version.",
        ...
        Property(
            ...
            required=True,
            description="Whole, non-abbreviated name of the interface version.",
        ...
        Property(
            ...
            IRI,
            "homepage",
            description="Main website of the interface version.",
        ...
        Property(
            ...
            unique_items=True,
            min_items=1,
            description="Significant word or concept that are representative of the interface version.",
        ...
        Property(
            ...
            formatting="text/plain",
            required=True,
            description="Shortened or fully abbreviated name of the interface version.",
