...
class AnnotationCriteriaType(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the annotation criteria type.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the annotation criteria type.",
...
from . import annotation_criteria_type_instances as _  # noqa: F401
