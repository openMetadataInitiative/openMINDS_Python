...
class TissueSampleAttribute(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the tissue sample attribute.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the tissue sample attribute.",
...
from . import tissue_sample_attribute_instances as _  # noqa: F401
