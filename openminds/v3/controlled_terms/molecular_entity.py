...
MolecularEntity.a1_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0100146"),
    name="A1 receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5717"),
...
MolecularEntity.a2_a_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0100148"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:7728#a2a-receptor"),
    name="A2A receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_7727"),
...
MolecularEntity.acetylcholine = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0100240"),
    name="acetylcholine",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/sao185580330"),
    synonyms=["ACh"],
)
MolecularEntity.alexa_fluor594 = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:51248#alexa-fluor-594"),
...
MolecularEntity.alpha_4_beta_2_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0597802"),
...
MolecularEntity.ampa_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0100559"),
    knowledge_space_link=IRI(
        "https://knowledge-space.org/wiki/NIFEXT:5251#ampa-type-glutamate-gated-cationic-channel"
    ),
    name="AMPA receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5251"),
    synonyms=[
...
MolecularEntity.anterograde_tracer = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:1012002#anterograde-tracer"),
...
MolecularEntity.beta__amyloid40 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0101246"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:20090708#beta-amyloid-40"),
    name="Beta-Amyloid 40",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_13181"),
...
MolecularEntity.biomarker = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0101294"),
    name="biomarker",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090517"),
)
MolecularEntity.biotinylated_dextran_amine = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0450726"),
...
MolecularEntity.brain_derived_neurotrophic_factor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0101140"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:20090401#bdnf"),
...
MolecularEntity.c_fos = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000007597#proto-oncogene-c-fos"),
    name="c-FOS",
...
MolecularEntity.calbindin = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0101551"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:1006006#calbindin-28k"),
    name="calbindin",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_1006006"),
...
MolecularEntity.calcium_calmodulin_protein_kinase_ii = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0101561"),
    knowledge_space_link=IRI(
...
MolecularEntity.calcium_chloride = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0101566"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:3312#calcium-dichloride"),
...
MolecularEntity.calretinin = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0101602"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:5#calretinin"),
    name="calretinin",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5717"),
...
MolecularEntity.carbon_dioxide = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0780969"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:16526#carbon-dioxide"),
    name="carbon dioxide",
...
MolecularEntity.cholecystokinin = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0102124"),
    name="cholecystokinin",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5068"),
    synonyms=["CCK"],
)
MolecularEntity.choline = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0102128"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:15354#choline"),
    name="choline",
...
MolecularEntity.choline_acetyltransferase = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0102129"),
    name="choline acetyltransferase",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/sao722953401"),
...
MolecularEntity.cyclic_adenosine_monophosphate = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0100318"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:17489#3-5-cyclic-amp"),
...
MolecularEntity.d1_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0102774"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:5845#d1-receptor-1"),
    name="D1 receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5845"),
...
MolecularEntity.d2_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0102775"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:5833#d2-receptor-3"),
    name="D2 receptor",
...
MolecularEntity.dab = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0482636"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:90994#3-3-diaminobenzidine"),
    name="DAB",
...
MolecularEntity.dimethyl_sulfoxide = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103278"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:28262#dimethyl-sulfoxide"),
...
MolecularEntity.dioxygen = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0398707"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:15379#dioxygen"),
    name="dioxygen",
...
MolecularEntity.dopamine = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103384"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:18243#dopamine"),
    name="dopamine",
...
MolecularEntity.dopamine_transporter = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103388"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:20090512#dopamine-transporter"),
...
MolecularEntity.dynorphin = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0103624"),
    name="dynorphin",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5097"),
    synonyms=["Dyn"],
)
...
MolecularEntity.enkephalin = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103826"),
    name="enkephalin",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5096"),
    synonyms=["Enk"],
)
MolecularEntity.epibatidine = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0103884"),
    name="epibatidine",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_chem_20090204"),
)
MolecularEntity.ethanol = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103948"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:16236#ethanol"),
    name="ethanol",
...
MolecularEntity.excitatory_amino_acid_transporter1 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103639"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000014974#excitatory-amino-acid-transporter-1"),
...
MolecularEntity.excitatory_amino_acid_transporter2 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103640"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000014973#excitatory-amino-acid-transporter-2"),
...
MolecularEntity.excitatory_amino_acid_transporter3 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103641"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000014972#excitatory-amino-acid-transporter-3"),
...
MolecularEntity.excitatory_amino_acid_transporter4 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103642"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000014977#excitatory-amino-acid-transporter-4"),
...
MolecularEntity.excitatory_amino_acid_transporter5 = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000014978#excitatory-amino-acid-transporter-5"),
...
MolecularEntity.five_ht1_a_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0100033"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:5891#5-ht1a-receptor-2"),
    name="5-HT1A receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5890"),
...
MolecularEntity.five_ht1_b_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0100034"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:6386#5-ht1b-receptor-3"),
    name="5-HT1B receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_6386"),
...
MolecularEntity.five_ht2_a_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0100038"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:6742#5-ht2a-receptor-1"),
    name="5-HT2A receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_6741"),
...
MolecularEntity.five_ht2_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0492260"),
    name="5-HT2 receptor",
...
MolecularEntity.five_ht4_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0100041"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:6151#5-ht4-receptor-1"),
    name="5-HT4 receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_6151"),
...
MolecularEntity.five_ht_transporter = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000015189#sodium-dependent-serotonin-transporter"),
...
MolecularEntity.flumazenil = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0104307"),
    name="flumazenil",
...
MolecularEntity.fluoro__gold = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0104323"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:1012018#fluorogold"),
    name="Fluoro-Gold",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_30125"),
...
MolecularEntity.fluoro__ruby = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0104322"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLX:65982#fluoro-ruby"),
    name="Fluoro-Ruby",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_65982"),
...
MolecularEntity.formaldehyde = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:16842#formaldehyde"),
    name="formaldehyde",
...
MolecularEntity.four_2_hydroxyethyl_1_piperazine_ethanesulfonic_acid = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0484759"),
    knowledge_space_link=IRI(
...
MolecularEntity.gaba_a_receptor = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/GO:1902711#gaba-a-receptor-complex"),
...
MolecularEntity.gaba_b_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0104503"),
    name="GABA-B receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_090801"),
...
MolecularEntity.gaba_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0104502"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/GO:1902710#gaba-receptor-complex"),
    name="GABA receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_1006001"),
...
MolecularEntity.galanin = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0104529"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:5074#galanin"),
    name="galanin",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5074"),
    synonyms=["GAL"],
)
MolecularEntity.gluconic_acid = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0402003"),
    name="gluconic acid",
...
MolecularEntity.glucose = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0104670"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:17234#glucose"),
    name="glucose",
...
MolecularEntity.glutamate = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0104676"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/SAO:1744435799#glutamate"),
    name="glutamate",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/sao1744435799"),
...
MolecularEntity.glutamate_transporter = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0104678"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/SAO:1399894198#glutamate-transporter"),
    name="glutamate transporter",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/sao1399894198"),
    synonyms=["GLT"],
)
MolecularEntity.glycerol = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:17754#glycerol"),
    name="glycerol",
...
MolecularEntity.growth_factor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0104801"),
    name="growth factor",
...
MolecularEntity.histamine = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0105065"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:5016#histamine"),
    name="histamine",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5016"),
)
MolecularEntity.insulin_like_growth_factor1 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0105523"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000009182#insulin-like-growth-factor-i"),
...
MolecularEntity.ionotropic_glutamate_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0105706"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:20090501#ionotropic-glutamate-receptor"),
    name="ionotropic glutamate receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090501"),
    synonyms=["iGluR"],
)
MolecularEntity.iperoxo = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0630403"),
    name="iperoxo",
...
MolecularEntity.iron = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0105721"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:24873#iron-molecular-entity"),
    name="iron",
...
MolecularEntity.isoflurane = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0105740"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:6015#isoflurane"),
    name="isoflurane",
...
MolecularEntity.kainate_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0105822"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:5252#kainate-glutamate-gated-cationic-channel"),
    name="kainate receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5252"),
    synonyms=[
...
MolecularEntity.kallikrein_related_peptidase8 = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000009614#kallikrein-1-related-peptidase-b8"),
...
MolecularEntity.ketamine = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0105850"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFSTD:DB01221#ketamine"),
    name="ketamine",
    preferred_ontology_identifier=IRI("https://www.drugbank.ca/drugs/DB01221"),
    synonyms=[
        "(-)-ketamine",
        "(S)-(-)-ketamine",
        "(S)-ketamine",
...
MolecularEntity.lucifer_yellow = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0439021"),
    name="lucifer yellow",
...
MolecularEntity.m1_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0106429"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:7352#m1-receptor-1"),
    name="M1 receptor",
...
MolecularEntity.m2_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0106430"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:7953#m2-receptor-2"),
    name="M2 receptor",
...
MolecularEntity.m3_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0106431"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:6135#m3-receptor"),
    name="M3 receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_6131"),
    synonyms=[
        "M3",
...
MolecularEntity.magnesium_atp = MolecularEntity(
    ...
    name="magnesium ATP",
    preferred_ontology_identifier=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/15126"),
    synonyms=["MgATP"],
)
MolecularEntity.magnesium_chloride = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:6636#magnesium-dichloride"),
...
MolecularEntity.magnesium_sulfate = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0106452"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:32599#magnesium-sulfate"),
...
MolecularEntity.medetomidine = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0488544"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:48552#medetomidine"),
    name="medetomidine",
...
MolecularEntity.metabotropic_glutamate_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0106829"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:20090503#metabotropic-glutamate-receptor"),
    name="metabotropic glutamate receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090503"),
...
MolecularEntity.metabotropic_glutamate_receptor1 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0106891"),
    name="metabotropic glutamate receptor 1",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090504"),
...
MolecularEntity.metabotropic_glutamate_receptor2 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0106892"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000008264#metabotropic-glutamate-receptor-2"),
    name="metabotropic glutamate receptor 2",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090505"),
...
MolecularEntity.metabotropic_glutamate_receptor3 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0106893"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000008265#metabotropic-glutamate-receptor-3"),
    name="metabotropic glutamate receptor 3",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090506"),
...
MolecularEntity.metabotropic_glutamate_receptor5 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0106895"),
    name="metabotropic glutamate receptor 5",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_mol_20090508"),
...
MolecularEntity.methanol = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:17790#methanol"),
    name="methanol",
...
MolecularEntity.monosodium_phosphate = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:37585#sodium-dihydrogenphosphate"),
...
MolecularEntity.muscimol = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0485557"),
    name="muscimol",
...
MolecularEntity.n_methyl_11c2_4_prime__methylaminophenyl_6_hydroxybenzothiazole = MolecularEntity(
    ...
    preferred_ontology_identifier=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/2826731"),
    synonyms=[
...
MolecularEntity.neurobiotin = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0107453"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:1012015#neurobiotin"),
    name="neurobiotin",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_157299"),
)
MolecularEntity.neuroligin_3 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0107485"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000011256#neuroligin-3"),
    name="neuroligin-3",
...
MolecularEntity.neuronal_nuclear_antigen = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0107517"),
    name="neuronal nuclear antigen",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nlx_152221"),
    synonyms=["NeuN"],
)
...
MolecularEntity.nickel = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0107575"),
    name="nickel",
...
MolecularEntity.nmda_receptor = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0107622"),
    knowledge_space_link=IRI(
        "https://knowledge-space.org/wiki/NIFEXT:5250#nmda-type-glutamate-gated-cationic-channel"
    ),
    name="NMDA receptor",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_5250"),
    synonyms=[
...
MolecularEntity.parvalbumin = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/ilx_0108558"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NIFEXT:6#parvalbumin"),
    name="parvalbumin",
    preferred_ontology_identifier=IRI("http://uri.neuinfo.org/nif/nifstd/nifext_6"),
    synonyms=["PV", "Pvalb"],
)
MolecularEntity.pentobarbital = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0108667"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:7983#pentobarbital"),
    name="pentobarbital",
...
MolecularEntity.potassium_chloride = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0109170"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:32588#potassium-chloride"),
...
MolecularEntity.silver_ammonium = MolecularEntity(
    ...
    preferred_ontology_identifier=IRI("https://pubchem.ncbi.nlm.nih.gov/compound/57440423"),
    synonyms=[],
)
...
MolecularEntity.sixcomma7_dinitro_1comma4_dihydroquinoxaline_2comma3_dione = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0103368"),
...
MolecularEntity.sodium_bicarbonate = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:32139#sodium-hydrogencarbonate"),
...
MolecularEntity.sodium_chloride = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:26710#sodium-chloride"),
...
MolecularEntity.sucrose = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:17992#sucrose"),
    name="sucrose",
...
MolecularEntity.vesicular_glutamate_transporter1 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0112442"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:1006007#vesicular-glutamate-transporter-1"),
...
MolecularEntity.vesicular_glutamate_transporter2 = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0112443"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/NLXMOL:1006009#vesicular-glutamate-transporter-2"),
...
MolecularEntity.vesicular_glutamate_transporter3 = MolecularEntity(
    ...
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/PR:000014964#vesicular-glutamate-transporter-3"),
...
MolecularEntity.water = MolecularEntity(
    ...
    interlex_identifier=IRI("http://uri.interlex.org/base/ilx_0782172"),
    knowledge_space_link=IRI("https://knowledge-space.org/wiki/CHEBI:15377#water"),
    name="water",
