...
class Software(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            multiline=True,
            required=True,
            description="Longer statement or account giving the characteristics of the software.",
        ...
        Property(
            "digital_identifier",
            ["openminds.v3.core.DOI", "openminds.v3.core.RRID", "openminds.v3.core.SWHID"],
            "digitalIdentifier",
        ...
        Property(
            ...
            required=True,
            description="Whole, non-abbreviated name of the software.",
        ...
        Property(
            ...
            IRI,
            "homepage",
            description="Main website of the software.",
        ...
        Property(
            ...
            formatting="text/plain",
            required=True,
            description="Shortened or fully abbreviated name of the software.",
