...
class SubjectGroupState(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            description="Term or code that identifies the subject group state within a particular product.",
        ...
        Property(
            "pathologies",
            ["openminds.v4.controlled_terms.Disease", "openminds.v4.controlled_terms.DiseaseModel"],
            "pathology",
            multiple=True,
            unique_items=True,
            min_items=1,
