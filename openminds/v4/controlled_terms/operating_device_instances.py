...
from openminds.v4.controlled_terms.operating_device import OperatingDevice
...
OperatingDevice.embedded_system = OperatingDevice(
    ...
    preferred_ontology_identifier=IRI("https://www.wikidata.org/entity/Q193040"),
)
...
OperatingDevice.neuromorphic_computer = OperatingDevice(
    ...
    preferred_ontology_identifier=IRI("https://www.wikidata.org/entity/Q56270917"),
)

OperatingDevice.server = OperatingDevice(
    id="https://openminds.om-i.org/instances/operatingDevice/server",
    name="server",
    preferred_ontology_identifier=IRI("https://www.wikidata.org/entity/Q64729893"),
)

OperatingDevice.web = OperatingDevice(
    id="https://openminds.om-i.org/instances/operatingDevice/web",
    name="web",
    preferred_ontology_identifier=IRI("https://www.wikidata.org/entity/Q6368"),
)
