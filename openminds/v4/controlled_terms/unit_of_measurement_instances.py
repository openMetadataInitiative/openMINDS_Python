...
UnitOfMeasurement.kiloohm = UnitOfMeasurement(
    ...
    name="kiloohm",
    preferred_ontology_identifier=IRI("http://www.ontology-of-units-of-measure.org/resource/om-2/kilohm"),
    synonyms=["kilohm", "kilo-ohm", "kΩ"],
)
