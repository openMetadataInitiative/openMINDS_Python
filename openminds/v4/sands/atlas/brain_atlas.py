...
class BrainAtlas(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "has_terminology",
            "openminds.v4.sands.ParcellationTerminology",
            "hasTerminology",
            required=True,
            description="no description available",
...
BrainAtlas.ba_human = BrainAtlas(
    ...
    has_versions=[{"@id": "https://openminds.om-i.org/instances/brainAtlasVersion/BA-human_1909"}],
...
BrainAtlas.dwma = BrainAtlas(
    ...
    has_versions=[{"@id": "https://openminds.om-i.org/instances/brainAtlasVersion/DWMA_2018"}],
...
BrainAtlas.marmoset_nma = BrainAtlas(
    ...
    has_versions=[{"@id": "https://openminds.om-i.org/instances/brainAtlasVersion/MarmosetNMA_v1"}],
...
BrainAtlas.swanson_bm = BrainAtlas(
    ...
    has_versions=[{"@id": "https://openminds.om-i.org/instances/brainAtlasVersion/SwansonBM_3rd-ed"}],
...
BrainAtlas.swma = BrainAtlas(
    ...
    has_versions=[{"@id": "https://openminds.om-i.org/instances/brainAtlasVersion/SWMA_2018"}],
