...
from openminds.v4.sands.atlas.common_coordinate_space import CommonCoordinateSpace

from openminds.v4.sands.atlas.common_coordinate_space_version import CommonCoordinateSpaceVersion
...
CommonCoordinateSpace.amb_ccf = CommonCoordinateSpace(
    ...
    has_versions=[
        CommonCoordinateSpaceVersion.amb_ccf_v3_ras,
        CommonCoordinateSpaceVersion.amb_ccf_v3,
        CommonCoordinateSpaceVersion.amb_ccf_v2,
        CommonCoordinateSpaceVersion.amb_ccf_v1,
    ],
...
CommonCoordinateSpace.big_brain = CommonCoordinateSpace(
    ...
    has_versions=[CommonCoordinateSpaceVersion.big_brain_2015],
...
CommonCoordinateSpace.fs_lr = CommonCoordinateSpace(
    ...
    has_versions=[CommonCoordinateSpaceVersion.fs_lr_32k, CommonCoordinateSpaceVersion.fs_lr_164k],
...
CommonCoordinateSpace.fsaverage = CommonCoordinateSpace(
    ...
    has_versions=[
        CommonCoordinateSpaceVersion.fsaverage_3,
        CommonCoordinateSpaceVersion.fsaverage_4,
        CommonCoordinateSpaceVersion.fsaverage_5,
        CommonCoordinateSpaceVersion.fsaverage_6,
        CommonCoordinateSpaceVersion.fsaverage_7,
    ],
...
CommonCoordinateSpace.marmoset_nmt = CommonCoordinateSpace(
    ...
    has_versions=[CommonCoordinateSpaceVersion.marmoset_nmt_v1],
...
CommonCoordinateSpace.mebrain_stemplate = CommonCoordinateSpace(
    ...
    has_versions=[CommonCoordinateSpaceVersion.mebrain_stemplate_v1_0],
    short_name="MEBRAINS brain template",
    used_species=Species.macaca_mulatta,
)
...
CommonCoordinateSpace.mni__colin27 = CommonCoordinateSpace(
    ...
    has_versions=[CommonCoordinateSpaceVersion.mni__colin27_1998, CommonCoordinateSpaceVersion.mni__colin27_2008],
...
CommonCoordinateSpace.mni_icbm152 = CommonCoordinateSpace(
    ...
    has_versions=[
        CommonCoordinateSpaceVersion.mni_icbm152_linear_2001_sym,
        CommonCoordinateSpaceVersion.mni_icbm152_nonlinear_6_g_sym,
        CommonCoordinateSpaceVersion.mni_icbm152_nonlinear_2009a_asym,
        CommonCoordinateSpaceVersion.mni_icbm152_nonlinear_2009a_sym,
        CommonCoordinateSpaceVersion.mni_icbm152_nonlinear_2009b_asym,
        CommonCoordinateSpaceVersion.mni_icbm152_nonlinear_2009b_sym,
        CommonCoordinateSpaceVersion.mni_icbm152_nonlinear_2009c_asym,
        CommonCoordinateSpaceVersion.mni_icbm152_nonlinear_2009c_sym,
    ],
    homepage=IRI("https://www.mcgill.ca/bic/software/tools-data-analysis/anatomical-mri/atlases"),
...
CommonCoordinateSpace.p__marmoset_bsc_cor_t = CommonCoordinateSpace(
    ...
    has_versions=[CommonCoordinateSpaceVersion.p__marmoset_bsc_cor_t_v2012__interaural_lsa],
...
CommonCoordinateSpace.pw_rbsc_cor_t = CommonCoordinateSpace(
    ...
    has_versions=[
        CommonCoordinateSpaceVersion.pw_rbsc_cor_t_v2004__bregma_lia,
        CommonCoordinateSpaceVersion.pw_rbsc_cor_t_v2004__bregma_ria,
        CommonCoordinateSpaceVersion.pw_rbsc_cor_t_v2004__interaural_lsa,
        CommonCoordinateSpaceVersion.pw_rbsc_cor_t_v2004__interaural_rsa,
    ],
...
CommonCoordinateSpace.swanson_srb = CommonCoordinateSpace(
    ...
    has_versions=[CommonCoordinateSpaceVersion.swanson_srb_v1992],
...
CommonCoordinateSpace.whssd = CommonCoordinateSpace(
    ...
    has_versions=[CommonCoordinateSpaceVersion.whssd_v1_01, CommonCoordinateSpaceVersion.whssd_v1],
