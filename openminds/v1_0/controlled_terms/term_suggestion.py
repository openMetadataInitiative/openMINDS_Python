...
class TermSuggestion(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "terminology",
            "openminds.v1_0.controlled_terms.Terminology",
            "vocab:terminology",
    ...
    def __init__(self, id=None, definition=None, description=None, name=None, ontology_identifier=None, terminology=None):
        return super().__init__(id=id,definition=definition,description=description,name=name,ontology_identifier=ontology_identifier,terminology=terminology,)
