...
class AnatomicalEntity(LinkedMetadata):
    ...
    def __init__(self, id=None, has_parent=None, name=None, ontology_identifier=None, other_anatomical_relation=None):
        return super().__init__(id=id,has_parent=has_parent,name=name,ontology_identifier=ontology_identifier,other_anatomical_relation=other_anatomical_relation,)
