...
class CoordinateSpace(LinkedMetadata):
    ...
    def __init__(self, id=None, anatomical_axes_orientation=None, axes_origin=None, default_image=None, digital_identifier=None, full_name=None, homepage=None, native_unit=None, ontology_identifier=None, release_date=None, short_name=None, version_identifier=None):
        return super().__init__(id=id,anatomical_axes_orientation=anatomical_axes_orientation,axes_origin=axes_origin,default_image=default_image,digital_identifier=digital_identifier,full_name=full_name,homepage=homepage,native_unit=native_unit,ontology_identifier=ontology_identifier,release_date=release_date,short_name=short_name,version_identifier=version_identifier,)
