...
class MetaDataModelVersion(LinkedMetadata):
    ...
    def __init__(self, id=None, accessibility=None, author=None, copyright=None, custodian=None, description=None, developer=None, digital_identifier=None, full_documentation=None, full_name=None, funding=None, has_alternative_version=None, has_supplement_version=None, homepage=None, is_new_version_of=None, keyword=None, license=None, other_contribution=None, related_publication=None, release_date=None, repository=None, serialization_format=None, short_name=None, specification_format=None, type=None, version_identifier=None, version_innovation=None):
        return super().__init__(id=id,accessibility=accessibility,author=author,copyright=copyright,custodian=custodian,description=description,developer=developer,digital_identifier=digital_identifier,full_documentation=full_documentation,full_name=full_name,funding=funding,has_alternative_version=has_alternative_version,has_supplement_version=has_supplement_version,homepage=homepage,is_new_version_of=is_new_version_of,keyword=keyword,license=license,other_contribution=other_contribution,related_publication=related_publication,release_date=release_date,repository=repository,serialization_format=serialization_format,short_name=short_name,specification_format=specification_format,type=type,version_identifier=version_identifier,version_innovation=version_innovation,)
