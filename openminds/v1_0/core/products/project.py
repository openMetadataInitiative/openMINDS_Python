...
class Project(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            ['openminds.v1_0.core.Dataset', 'openminds.v1_0.core.DatasetVersion', 'openminds.v1_0.core.MetaDataModel', 'openminds.v1_0.core.MetaDataModelVersion', 'openminds.v1_0.core.Model', 'openminds.v1_0.core.ModelVersion', 'openminds.v1_0.core.Software', 'openminds.v1_0.core.SoftwareVersion'],
    ...
    def __init__(self, id=None, description=None, full_name=None, has_research_products=None, homepage=None, project_leader=None, short_name=None):
        return super().__init__(id=id,description=description,full_name=full_name,has_research_products=has_research_products,homepage=homepage,project_leader=project_leader,short_name=short_name,)
