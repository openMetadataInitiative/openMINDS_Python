...
class FileBundle(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "grouped_by",
            "openminds.v1_0.controlled_terms.FileBundleGrouping",
            "vocab:groupedBy",
        ...
        Property(
            "is_part_of",
            ['openminds.v1_0.core.FileBundle', 'openminds.v1_0.core.FileRepository'],
    ...
    def __init__(self, id=None, iri=None, format=None, grouped_by=None, hash=None, is_part_of=None, name=None, storage_size=None):
        return super().__init__(id=id,iri=iri,format=format,grouped_by=grouped_by,hash=hash,is_part_of=is_part_of,name=name,storage_size=storage_size,)
