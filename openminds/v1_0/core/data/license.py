...
class License(LinkedMetadata):
    ...
    properties = [
        Property(
            "deed",
            str,
            "vocab:deed",formatting="text/plain",
        ...
        Property(
            "legal_code",
            str,
            "vocab:legalCode",formatting="text/plain",
    ...
    def __init__(self, id=None, deed=None, full_name=None, legal_code=None, short_name=None):
        return super().__init__(id=id,deed=deed,full_name=full_name,legal_code=legal_code,short_name=short_name,)
