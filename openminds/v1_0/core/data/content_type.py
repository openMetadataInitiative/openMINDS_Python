...
class ContentType(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "category",
            str,
            "vocab:category",formatting="text/plain",
        ...
        Property(
            "related_media_type",
            str,
            "vocab:relatedMediaType",formatting="text/plain",
    ...
    def __init__(self, id=None, associated_file_extension=None, category=None, name=None, related_media_type=None, synonym=None):
        return super().__init__(id=id,associated_file_extension=associated_file_extension,category=category,name=name,related_media_type=related_media_type,synonym=synonym,)
