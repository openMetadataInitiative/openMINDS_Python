...
class Protocol(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            "study_target",
            [
                "openminds.v1_0.controlled_term.BiologicalSex",
                "openminds.v1_0.controlled_term.Disease",
                "openminds.v1_0.controlled_term.Genotype",
                "openminds.v1_0.controlled_term.Phenotype",
                "openminds.v1_0.controlled_term.Species",
                "openminds.v1_0.controlled_term.TermSuggestion",
