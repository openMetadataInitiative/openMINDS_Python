...
class SoftwareFeatureCategory(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the software feature category.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the software feature category.",
        ...
        Property(
            ...
            "ontologyIdentifier",
            formatting="text/plain",
            description="Term or code used to identify the software feature category registered within a particular ontology.",
