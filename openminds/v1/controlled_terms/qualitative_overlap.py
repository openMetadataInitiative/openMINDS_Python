...
class QualitativeOverlap(LinkedMetadata):
    ...
    properties = [
        ...
        Property(
            ...
            formatting="text/markdown",
            multiline=True,
            description="Longer statement or account giving the characteristics of the qualitative overlap.",
        ...
        Property(
            ...
            required=True,
            description="Word or phrase that constitutes the distinctive designation of the qualitative overlap.",
        ...
        Property(
            ...
            "ontologyIdentifier",
            formatting="text/plain",
            description="Term or code used to identify the qualitative overlap registered within a particular ontology.",
